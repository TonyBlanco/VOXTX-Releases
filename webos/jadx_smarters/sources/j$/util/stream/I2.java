...
final class I2 extends B {
    ...
    public final K0 O(AbstractC1940b abstractC1940b, Spliterator spliterator, IntFunction intFunction) {
        ...
        double[] dArr = (double[]) ((E0) abstractC1940b.C(spliterator, true, intFunction)).e();
        Arrays.sort(dArr);
        return new X0(dArr);
    }
    ...
    public final InterfaceC2018q2 R(int i9, InterfaceC2018q2 interfaceC2018q2) {
        ...
        return EnumC1959e3.SORTED.q(i9) ? interfaceC2018q2 : EnumC1959e3.SIZED.q(i9) ? new N2(interfaceC2018q2) : new F2(interfaceC2018q2);
    }
}
