...
final class T1 implements U1, InterfaceC2013p2 {
    ...
    final /* synthetic */ LongBinaryOperator f42546c;

    T1(LongBinaryOperator longBinaryOperator) {
        this.f42546c = longBinaryOperator;
    }
    ...
    public final void accept(long j9) {
        if (this.f42544a) {
            ...
            j9 = this.f42546c.applyAsLong(this.f42545b, j9);
        }
        this.f42545b = j9;
    }
    ...
    public final Object get() {
        return this.f42544a ? C1929m.a() : C1929m.d(this.f42545b);
    }
