...
public abstract class e {
    ...
    public void g(String str, String str2, String str3, int i9, int i10, String... strArr) {
        if (h(strArr)) {
            j(str, str2, str3, i9, i10, strArr);
        } else {
            a(i10, strArr);
        }
    }
    ...
    public abstract void j(String str, String str2, String str3, int i9, int i10, String... strArr);
