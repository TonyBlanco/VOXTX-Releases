...
final class Utils {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        public String toString() {
            ...
            for (int i9 = 1; i9 < this.typeArguments.length; i9++) {
                sb.append(", ");
                sb.append(Utils.typeToString(this.typeArguments[i9]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static Type getParameterUpperBound(int i9, ParameterizedType parameterizedType) {
        ...
        throw new IllegalArgumentException("Index " + i9 + " not in range [0," + actualTypeArguments.length + ") for " + parameterizedType);
    }
    ...
    public static RuntimeException parameterError(Method method, int i9, String str, Object... objArr) {
        return methodError(method, str + " (parameter #" + (i9 + 1) + ")", objArr);
    }

    public static RuntimeException parameterError(Method method, Throwable th, int i9, String str, Object... objArr) {
        return methodError(method, th, str + " (parameter #" + (i9 + 1) + ")", objArr);
    }
    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if (type3 instanceof ParameterizedType) {
            ...
            boolean z9 = typeResolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i9 = 0; i9 < length; i9++) {
                Type typeResolve4 = resolve(type, cls, actualTypeArguments[i9]);
                if (typeResolve4 != actualTypeArguments[i9]) {
                    if (!z9) {
                        actualTypeArguments = (Type[]) actualTypeArguments.clone();
                        z9 = true;
                    }
                    actualTypeArguments[i9] = typeResolve4;
                }
            }
            return z9 ? new ParameterizedTypeImpl(typeResolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
