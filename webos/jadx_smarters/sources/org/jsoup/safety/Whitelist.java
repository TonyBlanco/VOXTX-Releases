...
public class Whitelist {
    ...
    public static Whitelist basic() {
        return new Whitelist().addTags("a", "b", "blockquote", "br", "cite", "code", "dd", "dl", "dt", "em", "i", "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "u", "ul").addAttributes("a", "href").addAttributes("blockquote", "cite").addAttributes("q", "cite").addProtocols("a", "href", "ftp", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME, "mailto").addProtocols("blockquote", "cite", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME).addProtocols("cite", "cite", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME).addEnforcedAttribute("a", "rel", "nofollow");
    }
    ...
    public static Whitelist relaxed() {
        return new Whitelist().addTags("a", "b", "blockquote", "br", "caption", "cite", "code", "col", "colgroup", "dd", "div", "dl", "dt", "em", "h1", "h2", "h3", "h4", "h5", "h6", "i", "img", "li", "ol", "p", "pre", "q", "small", "span", "strike", "strong", "sub", "sup", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "u", "ul").addAttributes("a", "href", ChartFactory.TITLE).addAttributes("blockquote", "cite").addAttributes("col", "span", "width").addAttributes("colgroup", "span", "width").addAttributes("img", "align", "alt", "height", "src", ChartFactory.TITLE, "width").addAttributes("ol", "start", "type").addAttributes("q", "cite").addAttributes("table", "summary", "width").addAttributes("td", "abbr", "axis", "colspan", "rowspan", "width").addAttributes("th", "abbr", "axis", "colspan", "rowspan", ClientConstants.DOMAIN_QUERY_PARAM_SCOPES, "width").addAttributes("ul", "type").addProtocols("a", "href", "ftp", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME, "mailto").addProtocols("blockquote", "cite", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME).addProtocols("cite", "cite", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME).addProtocols("img", "src", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME).addProtocols("q", "cite", HttpHost.DEFAULT_SCHEME_NAME, ClientConstants.DOMAIN_SCHEME);
    }
    ...
    private boolean testValidProtocol(Element element, Attribute attribute, Set<Protocol> set) {
        ...
        while (it.hasNext()) {
            ...
            if (!string.equals(ModelIdentifier.Helper.PRIMARY_KEY_DELIMITER)) {
    ...
    public Whitelist preserveRelativeLinks(boolean z9) {
        this.preserveRelativeLinks = z9;
        return this;
    }
