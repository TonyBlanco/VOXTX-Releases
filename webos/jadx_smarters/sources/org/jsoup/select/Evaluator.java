...
public abstract class Evaluator {
    ...
    public static abstract class AttributeKeyPair extends Evaluator {
        ...
        public AttributeKeyPair(String str, String str2) {
            ...
            if (str2.startsWith(ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR) && str2.endsWith(ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR)) {
    ...
    public static abstract class CssNthEvaluator extends Evaluator {
        ...
        protected final int f46158a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        protected final int f46159b;

        public CssNthEvaluator(int i9) {
            this(0, i9);
        }

        public CssNthEvaluator(int i9, int i10) {
            this.f46158a = i9;
            this.f46159b = i10;
        }
        ...
        public boolean matches(Element element, Element element2) {
            ...
            int i9 = this.f46158a;
            if (i9 == 0) {
                return iCalculatePosition == this.f46159b;
            }
            int i10 = this.f46159b;
            return (iCalculatePosition - i10) * i9 >= 0 && (iCalculatePosition - i10) % i9 == 0;
        }

        public String toString() {
            return this.f46158a == 0 ? String.format(":%s(%d)", getPseudoClass(), Integer.valueOf(this.f46159b)) : this.f46159b == 0 ? String.format(":%s(%dn)", getPseudoClass(), Integer.valueOf(this.f46158a)) : String.format(":%s(%dn%+d)", getPseudoClass(), Integer.valueOf(this.f46158a), Integer.valueOf(this.f46159b));
        }
    }
    ...
    public static abstract class IndexEvaluator extends Evaluator {
        ...
        public IndexEvaluator(int i9) {
            this.index = i9;
        }
    }

    public static final class IndexGreaterThan extends IndexEvaluator {
        public IndexGreaterThan(int i9) {
            super(i9);
        }
    ...
    public static final class IsEmpty extends Evaluator {
        ...
        public boolean matches(Element element, Element element2) {
            ...
            for (int i9 = 0; i9 < listChildNodes.size(); i9++) {
                Node node = listChildNodes.get(i9);
    ...
    public static final class IsNthChild extends CssNthEvaluator {
        public IsNthChild(int i9, int i10) {
            super(i9, i10);
        }
    ...
    public static final class IsNthLastChild extends CssNthEvaluator {
        public IsNthLastChild(int i9, int i10) {
            super(i9, i10);
        }
    ...
    public static class IsNthLastOfType extends CssNthEvaluator {
        public IsNthLastOfType(int i9, int i10) {
            super(i9, i10);
        }
    ...
    public static class IsNthOfType extends CssNthEvaluator {
        public IsNthOfType(int i9, int i10) {
            super(i9, i10);
        }
        ...
        public int calculatePosition(Element element, Element element2) {
            Elements elementsChildren = element2.parent().children();
            int i9 = 0;
            for (int i10 = 0; i10 < elementsChildren.size(); i10++) {
                if (elementsChildren.get(i10).tag().equals(element2.tag())) {
                    i9++;
                }
                if (elementsChildren.get(i10) == element2) {
                    break;
                }
            }
            return i9;
