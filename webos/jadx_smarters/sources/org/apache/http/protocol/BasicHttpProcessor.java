...
public final class BasicHttpProcessor implements HttpProcessor, HttpRequestInterceptorList, HttpResponseInterceptorList, Cloneable {
    ...
    public final void addInterceptor(HttpRequestInterceptor httpRequestInterceptor, int i9) {
        addRequestInterceptor(httpRequestInterceptor, i9);
    }
    ...
    public final void addInterceptor(HttpResponseInterceptor httpResponseInterceptor, int i9) {
        addResponseInterceptor(httpResponseInterceptor, i9);
    }
    ...
    @Override // org.apache.http.protocol.HttpRequestInterceptorList
    public void addRequestInterceptor(HttpRequestInterceptor httpRequestInterceptor, int i9) {
        if (httpRequestInterceptor == null) {
            return;
        }
        this.requestInterceptors.add(i9, httpRequestInterceptor);
    }
    ...
    @Override // org.apache.http.protocol.HttpResponseInterceptorList
    public void addResponseInterceptor(HttpResponseInterceptor httpResponseInterceptor, int i9) {
        if (httpResponseInterceptor == null) {
            return;
        }
        this.responseInterceptors.add(i9, httpResponseInterceptor);
    }
    ...
    @Override // org.apache.http.protocol.HttpRequestInterceptorList
    public HttpRequestInterceptor getRequestInterceptor(int i9) {
        if (i9 < 0 || i9 >= this.requestInterceptors.size()) {
            return null;
        }
        return this.requestInterceptors.get(i9);
    }
    ...
    @Override // org.apache.http.protocol.HttpResponseInterceptorList
    public HttpResponseInterceptor getResponseInterceptor(int i9) {
        if (i9 < 0 || i9 >= this.responseInterceptors.size()) {
            return null;
        }
        return this.responseInterceptors.get(i9);
    }
