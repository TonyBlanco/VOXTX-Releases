...
public class ConnectionConfig implements Cloneable {
    ...
    public static class Builder {
        ...
        public ConnectionConfig build() {
            ...
            int i10 = i9 > 0 ? i9 : Segment.SIZE;
            int i11 = this.fragmentSizeHint;
            return new ConnectionConfig(i10, i11 >= 0 ? i11 : i10, charset2, this.malformedInputAction, this.unmappableInputAction, this.messageConstraints);
        }
        ...
        public Builder setFragmentSizeHint(int i9) {
    ...
    public ConnectionConfig(int i9, int i10, Charset charset, CodingErrorAction codingErrorAction, CodingErrorAction codingErrorAction2, MessageConstraints messageConstraints) {
        this.bufferSize = i9;
