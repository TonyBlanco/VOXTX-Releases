...
public class BasicHttpClientConnectionManager implements HttpClientConnectionManager, Closeable {
    ...
    private synchronized void closeConnection() {
        if (this.conn != null) {
            ...
            try {
                ...
                if (this.log.isDebugEnabled()) {
                    this.log.debug("I/O exception closing connection", e9);
                }
            }
            this.conn = null;
        }
    ...
    public void connect(HttpClientConnection httpClientConnection, HttpRoute httpRoute, int i9, HttpContext httpContext) throws IOException {
        ...
        this.connectionOperator.connect(this.conn, httpRoute.getProxyHost() != null ? httpRoute.getProxyHost() : httpRoute.getTargetHost(), httpRoute.getLocalSocketAddress(), i9, this.socketConfig, httpContext);
    }
    ...
    @Override // org.apache.http.conn.HttpClientConnectionManager
    public synchronized void releaseConnection(HttpClientConnection httpClientConnection, Object obj, long j9, TimeUnit timeUnit) {
        String str;
        try {
            Args.notNull(httpClientConnection, "Connection");
            Asserts.check(httpClientConnection == this.conn, "Connection not obtained from this manager");
