...
public class DefaultClientConnection extends SocketHttpClientConnection implements OperatedClientConnection, ManagedHttpClientConnection, HttpContext {
    ...
    public SessionInputBuffer createSessionInputBuffer(Socket socket, int i9, HttpParams httpParams) throws IOException {
        if (i9 <= 0) {
            i9 = Segment.SIZE;
        }
        SessionInputBuffer sessionInputBufferCreateSessionInputBuffer = super.createSessionInputBuffer(socket, i9, httpParams);
    ...
    @Override // org.apache.http.impl.SocketHttpClientConnection
    public SessionOutputBuffer createSessionOutputBuffer(Socket socket, int i9, HttpParams httpParams) throws IOException {
        if (i9 <= 0) {
            i9 = Segment.SIZE;
        }
        SessionOutputBuffer sessionOutputBufferCreateSessionOutputBuffer = super.createSessionOutputBuffer(socket, i9, httpParams);
    ...
    @Override // org.apache.http.conn.OperatedClientConnection
    public void openCompleted(boolean z9, HttpParams httpParams) throws IOException {
    ...
    public void shutdown() throws IOException {
        ...
        try {
            ...
            this.log.debug("I/O error shutting down connection", e9);
        }
    }

    @Override // org.apache.http.conn.OperatedClientConnection
    public void update(Socket socket, HttpHost httpHost, boolean z9, HttpParams httpParams) throws IOException {
        assertOpen();
