...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager3 == null) {
            ...
            Registry registryBuild = RegistryBuilder.create().register(HttpHost.DEFAULT_SCHEME_NAME, PlainConnectionSocketFactory.getSocketFactory()).register(ClientConstants.DOMAIN_SCHEME, sSLConnectionSocketFactory2).build();
            DnsResolver dnsResolver = this.dnsResolver;
            long j9 = this.connTimeToLive;
            TimeUnit timeUnit = this.connTimeToLiveTimeUnit;
            if (timeUnit == null) {
                timeUnit = TimeUnit.MILLISECONDS;
            }
            PoolingHttpClientConnectionManager poolingHttpClientConnectionManager = new PoolingHttpClientConnectionManager(registryBuild, null, null, dnsResolver, j9, timeUnit);
            ...
            if (this.systemProperties && "true".equalsIgnoreCase(System.getProperty("http.keepAlive", "true"))) {
                int i9 = Integer.parseInt(System.getProperty("http.maxConnections", "5"));
                poolingHttpClientConnectionManager.setDefaultMaxPerRoute(i9);
                poolingHttpClientConnectionManager.setMaxTotal(i9 * 2);
            }
        ...
        if (this.connManagerShared) {
            ...
            if (this.evictExpiredConnections || this.evictIdleConnections) {
                long j10 = this.maxIdleTime;
                long j11 = j10 > 0 ? j10 : 10L;
                TimeUnit timeUnit2 = this.maxIdleTimeUnit;
                httpClientConnectionManager2 = httpClientConnectionManager;
                final IdleConnectionEvictor idleConnectionEvictor = new IdleConnectionEvictor(httpClientConnectionManager2, j11, timeUnit2 != null ? timeUnit2 : TimeUnit.SECONDS, j10, timeUnit2);
        ...
        return new InternalHttpClient(clientExecChainDecorateProtocolExec, httpClientConnectionManager2, defaultProxyRoutePlanner, lookupCreateDefault, lookupBuild, basicCookieStore, systemDefaultCredentialsProvider, requestConfig, arrayList3);
    }
    ...
    public final HttpClientBuilder evictIdleConnections(long j9, TimeUnit timeUnit) {
    ...
    @Deprecated
    public final HttpClientBuilder evictIdleConnections(Long l9, TimeUnit timeUnit) {
        return evictIdleConnections(l9.longValue(), timeUnit);
    }
    ...
    public final HttpClientBuilder setConnectionManagerShared(boolean z9) {
        this.connManagerShared = z9;
        return this;
    }
    ...
    public final HttpClientBuilder setConnectionTimeToLive(long j9, TimeUnit timeUnit) {
        this.connTimeToLive = j9;
    ...
    public final HttpClientBuilder setMaxConnPerRoute(int i9) {
        this.maxConnPerRoute = i9;
        return this;
    }

    public final HttpClientBuilder setMaxConnTotal(int i9) {
        this.maxConnTotal = i9;
        return this;
    }
