...
public class BasicAuthCache implements AuthCache {
        ...
        if (bArr != null) {
            try {
                ...
                if (this.log.isWarnEnabled()) {
                    this.log.warn("Unexpected I/O error while de-serializing auth scheme", e9);
                }
            } catch (ClassNotFoundException e10) {
                if (this.log.isWarnEnabled()) {
                    this.log.warn("Unexpected error while de-serializing auth scheme", e10);
                }
                return null;
            }
        }
    ...
    public void put(HttpHost httpHost, AuthScheme authScheme) {
        ...
        try {
            ...
            if (this.log.isWarnEnabled()) {
                this.log.warn("Unexpected I/O error while serializing auth scheme", e9);
            }
        }
    }
