...
public final class RouteTracker implements RouteInfo, Cloneable {
    ...
    public final void connectProxy(HttpHost httpHost, boolean z9) {
    ...
    public final void connectTarget(boolean z9) {
        Asserts.check(!this.connected, "Already connected");
        this.connected = true;
        this.secure = z9;
    }
    ...
    public final HttpHost getHopTarget(int i9) {
        ...
        return i9 < hopCount - 1 ? this.proxyChain[i9] : this.targetHost;
    }
    ...
    public final void layerProtocol(boolean z9) {
    ...
    public final void tunnelProxy(HttpHost httpHost, boolean z9) {
        Args.notNull(httpHost, "Proxy host");
    ...
    public final void tunnelTarget(boolean z9) {
        Asserts.check(this.connected, "No tunnel unless connected");
        Asserts.notNull(this.proxyChain, "No tunnel without proxy");
