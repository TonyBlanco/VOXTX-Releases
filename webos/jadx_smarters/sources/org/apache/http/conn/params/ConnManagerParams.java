...
public final class ConnManagerParams implements ConnManagerPNames {
    ...
    public static void setMaxTotalConnections(HttpParams httpParams, int i9) {
        Args.notNull(httpParams, "HTTP parameters");
        httpParams.setIntParameter(ConnManagerPNames.MAX_TOTAL_CONNECTIONS, i9);
    }

    @Deprecated
    public static void setTimeout(HttpParams httpParams, long j9) {
        Args.notNull(httpParams, "HTTP parameters");
