...
public class SSLSocketFactory implements LayeredConnectionSocketFactory, SchemeLayeredSocketFactory, LayeredSchemeSocketFactory, LayeredSocketFactory {
    ...
    public Socket connectSocket(Socket socket, String str, int i9, InetAddress inetAddress, int i10, HttpParams httpParams) throws IOException {
        ...
        return connectSocket(socket, new HttpInetSocketAddress(new HttpHost(str, i9), inetAddressResolve, i9), inetSocketAddress, httpParams);
    }
    ...
    public Socket createLayeredSocket(Socket socket, String str, int i9, HttpParams httpParams) throws IOException {
        return createLayeredSocket(socket, str, i9, (HttpContext) null);
    }

    @Override // org.apache.http.conn.socket.LayeredConnectionSocketFactory
    public Socket createLayeredSocket(Socket socket, String str, int i9, HttpContext httpContext) throws IOException {
    ...
    public Socket createLayeredSocket(Socket socket, String str, int i9, boolean z9) throws IOException {
        return createLayeredSocket(socket, str, i9, (HttpContext) null);
    }
    ...
    public Socket createSocket(Socket socket, String str, int i9, boolean z9) throws IOException {
        return createLayeredSocket(socket, str, i9, z9);
    }
