...
public final class Scheme {
    ...
    public Scheme(String str, int i9, SchemeSocketFactory schemeSocketFactory) {
        Args.notNull(str, "Scheme name");
        Args.check(i9 > 0 && i9 <= 65535, "Port is invalid");
    ...
    @Deprecated
    public Scheme(String str, SocketFactory socketFactory, int i9) {
        Args.notNull(str, "Scheme name");
