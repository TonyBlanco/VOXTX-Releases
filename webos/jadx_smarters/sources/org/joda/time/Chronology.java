...
public abstract class Chronology {
    public abstract long add(long j9, long j10, int i9);

    public abstract long add(ReadablePeriod readablePeriod, long j9, int i9);
    ...
    public abstract int[] get(ReadablePartial readablePartial, long j9);

    public abstract int[] get(ReadablePeriod readablePeriod, long j9);

    public abstract int[] get(ReadablePeriod readablePeriod, long j9, long j10);

    public abstract long getDateTimeMillis(int i9, int i10, int i11, int i12);

    public abstract long getDateTimeMillis(int i9, int i10, int i11, int i12, int i13, int i14, int i15);

    public abstract long getDateTimeMillis(long j9, int i9, int i10, int i11, int i12);
    ...
    public abstract long set(ReadablePartial readablePartial, long j9);
