...
public abstract class BaseDuration extends AbstractDuration implements ReadableDuration, Serializable {
    ...
    public BaseDuration(long j9) {
        this.iMillis = j9;
    }

    public BaseDuration(long j9, long j10) {
        this.iMillis = FieldUtils.safeSubtract(j10, j9);
    }
    ...
    public BaseDuration(ReadableInstant readableInstant, ReadableInstant readableInstant2) {
        ...
        if (readableInstant == readableInstant2) {
            ...
            jSafeSubtract = FieldUtils.safeSubtract(DateTimeUtils.getInstantMillis(readableInstant2), DateTimeUtils.getInstantMillis(readableInstant));
        }
        this.iMillis = jSafeSubtract;
    }
