...
public interface ICustomTabsService extends IInterface {
            ...
            public boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int i9, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(12, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                        boolean zReceiveFile = Stub.getDefaultImpl().receiveFile(iCustomTabsCallback, uri, i9, bundle);
                        parcelObtain2.recycle();
                        parcelObtain.recycle();
                        return zReceiveFile;
                    }
            ...
            public boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int i9, Uri uri, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(9, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                        boolean zValidateRelationship = Stub.getDefaultImpl().validateRelationship(iCustomTabsCallback, i9, uri, bundle);
                        parcelObtain2.recycle();
                        parcelObtain.recycle();
            ...
            public boolean warmup(long j9) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.mRemote.transact(2, parcelObtain, parcelObtain2, 0) && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().warmup(j9);
                    }
                    parcelObtain2.readException();
    ...
    boolean receiveFile(ICustomTabsCallback iCustomTabsCallback, Uri uri, int i9, Bundle bundle) throws RemoteException;
    ...
    boolean validateRelationship(ICustomTabsCallback iCustomTabsCallback, int i9, Uri uri, Bundle bundle) throws RemoteException;

    boolean warmup(long j9) throws RemoteException;
}
