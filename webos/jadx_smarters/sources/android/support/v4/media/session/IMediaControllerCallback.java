...
public interface IMediaControllerCallback extends IInterface {
        ...
        public static class Proxy implements IMediaControllerCallback {
            ...
            public void onCaptioningEnabledChanged(boolean z9) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onCaptioningEnabledChanged(z9);
                } finally {
            ...
            public void onRepeatModeChanged(int i9) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onRepeatModeChanged(i9);
                } finally {
                    parcelObtain.recycle();
                }
            }
            ...
            public void onShuffleModeChanged(int i9) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onShuffleModeChanged(i9);
                } finally {
                    parcelObtain.recycle();
                }
            }
            ...
            public void onShuffleModeChangedRemoved(boolean z9) throws RemoteException {
                ...
                try {
                    ...
                    Stub.getDefaultImpl().onShuffleModeChangedRemoved(z9);
                } finally {
                    parcelObtain.recycle();
                }
            }
    ...
    void onCaptioningEnabledChanged(boolean z9) throws RemoteException;
    ...
    void onRepeatModeChanged(int i9) throws RemoteException;

    void onSessionDestroyed() throws RemoteException;

    void onSessionReady() throws RemoteException;

    void onShuffleModeChanged(int i9) throws RemoteException;

    void onShuffleModeChangedRemoved(boolean z9) throws RemoteException;
