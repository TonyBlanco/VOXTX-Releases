...
public final class JsonAdapterAnnotationTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (objConstruct instanceof TypeAdapter) {
            ...
            boolean z9 = objConstruct instanceof JsonSerializer;
            if (!z9 && !(objConstruct instanceof JsonDeserializer)) {
            ...
            treeTypeAdapter = new TreeTypeAdapter<>(z9 ? (JsonSerializer) objConstruct : null, objConstruct instanceof JsonDeserializer ? (JsonDeserializer) objConstruct : null, gson, typeToken, null);
        }
