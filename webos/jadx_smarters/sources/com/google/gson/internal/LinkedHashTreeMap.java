...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public static final class AvlBuilder<K, V> {
        ...
        public void reset(int i9) {
            this.leavesToSkip = ((Integer.highestOneBit(i9) * 2) - 1) - i9;
            this.size = 0;
            this.leavesSkipped = 0;
            this.stack = null;
        }
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(Node<K, V> node, K k9, int i9, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k9;
            this.hash = i9;
            this.height = 1;
    ...
    public static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] nodeArr) {
        ...
        for (int i9 = 0; i9 < length; i9++) {
            ...
            if (node != null) {
                ...
                nodeArr2[i9] = i10 > 0 ? avlBuilder.root() : null;
                nodeArr2[i9 + length] = i11 > 0 ? avlBuilder2.root() : null;
            }
        }
        return nodeArr2;
    }
    ...
    private void replaceInParent(Node<K, V> node, Node<K, V> node2) {
        ...
        if (node3 == null) {
            int i9 = node.hash;
            this.table[i9 & (r0.length - 1)] = node2;
    ...
    public Node<K, V> find(K k9, boolean z9) {
        ...
        int iSecondaryHash = secondaryHash(k9.hashCode());
        ...
        if (node3 != null) {
            ...
            while (true) {
                K k10 = node3.key;
                int iCompareTo = comparable != null ? comparable.compareTo(k10) : comparator.compare(k9, k10);
                if (iCompareTo == 0) {
                    return node3;
                }
        ...
        if (node != null) {
            node2 = new Node<>(node, k9, iSecondaryHash, node5, node5.prev);
            if (i9 < 0) {
                node.left = node2;
            } else {
                node.right = node2;
