...
public final class Gson {
    ...
    private TypeAdapter<Number> doubleAdapter(boolean z9) {
        return z9 ? TypeAdapters.DOUBLE : new TypeAdapter<Number>() { // from class: com.google.gson.Gson.1
            @Override // com.google.gson.TypeAdapter
    ...
    private TypeAdapter<Number> floatAdapter(boolean z9) {
        return z9 ? TypeAdapters.FLOAT : new TypeAdapter<Number>() { // from class: com.google.gson.Gson.2
            @Override // com.google.gson.TypeAdapter
            /* JADX INFO: renamed from: read */
            public Number read2(JsonReader jsonReader) throws IOException {
                if (jsonReader.peek() != JsonToken.NULL) {
    ...
    public <T> T fromJson(Reader reader, Type type) throws JsonSyntaxException, JsonIOException {
        JsonReader jsonReaderNewJsonReader = newJsonReader(reader);
        T t9 = (T) fromJson(jsonReaderNewJsonReader, type);
        assertFullConsumption(t9, jsonReaderNewJsonReader);
        return t9;
    }
