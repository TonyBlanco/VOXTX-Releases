...
final class zzfh extends zzfk {
    ...
    public final void zzn(String str) throws IOException {
        int i9 = this.zze;
        try {
            int iZzy = zzfk.zzy(str.length() * 3);
            int iZzy2 = zzfk.zzy(str.length());
            if (iZzy2 != iZzy) {
                zzq(zzju.zzc(str));
                byte[] bArr = this.zzc;
                int i10 = this.zze;
            ...
            int i11 = i9 + iZzy2;
            this.zze = i11;
            int iZzb = zzju.zzb(str, this.zzc, i11, this.zzd - i11);
            this.zze = i9;
            zzq((iZzb - i9) - iZzy2);
            this.zze = iZzb;
        } catch (zzjt e9) {
    ...
    public final void zzs(long j9) throws IOException {
        if (zzfk.zzd && this.zzd - this.zze >= 10) {
            while ((j9 & (-128)) != 0) {
                ...
                int i9 = this.zze;
                this.zze = i9 + 1;
                zzjp.zzn(bArr, i9, (byte) ((((int) j9) & 127) | 128));
                j9 >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i10 = this.zze;
            this.zze = 1 + i10;
            zzjp.zzn(bArr2, i10, (byte) j9);
            return;
        }
        while ((j9 & (-128)) != 0) {
            try {
