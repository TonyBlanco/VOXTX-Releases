...
public final class zzv extends zzai {
    ...
    public final zzap zza(zzg zzgVar, List list) {
        ...
        this.zza.zza(strZzi, zzamVar.zzt(LogFactory.PRIORITY_KEY) ? zzh.zzb(zzamVar.zzf(LogFactory.PRIORITY_KEY).zzh().doubleValue()) : 1000, (zzao) zzapVarZzb, zzamVar.zzf("type").zzi());
        return zzap.zzf;
    }
}
