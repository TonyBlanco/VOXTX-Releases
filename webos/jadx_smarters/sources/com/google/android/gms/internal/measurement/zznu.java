...
final class zznu {
    ...
    public static void zzD(Object obj, long j9, byte b9) {
        zznt zzntVar = zzf;
        long j10 = (-4) & j9;
        int i9 = zzntVar.zza.getInt(obj, j10);
        int i10 = ((~((int) j9)) & 3) << 3;
        zzntVar.zza.putInt(obj, j10, ((255 & b9) << i10) | (i9 & (~(255 << i10))));
    }
    ...
    public static void zzE(Object obj, long j9, byte b9) {
        ...
        long j10 = (-4) & j9;
        int i9 = (((int) j9) & 3) << 3;
        zzntVar.zza.putInt(obj, j10, ((255 & b9) << i9) | (zzntVar.zza.getInt(obj, j10) & (~(255 << i9))));
    }
