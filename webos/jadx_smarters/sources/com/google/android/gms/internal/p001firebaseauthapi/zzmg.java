    ...
    public static ECPoint zza(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzmjVarZza = zza(zzmjVarZza, zzmjVarZza2, a9, bigIntegerZza);
                zzmjVarZza2 = zza(zzmjVarZza2, a9, bigIntegerZza);
            } else {
                zzmjVarZza2 = zza(zzmjVarZza, zzmjVarZza2, a9, bigIntegerZza);
                zzmjVarZza = zza(zzmjVarZza, a9, bigIntegerZza);
            }
        }
        if (zzmjVarZza.zza()) {
