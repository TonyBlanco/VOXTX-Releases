...
public final class zzay extends zzaw {
    ...
    private static boolean zzc(zzap zzapVar, zzap zzapVar2) {
        ...
        boolean z9 = zzapVar instanceof zzah;
        if (z9 && (zzapVar2 instanceof zzat)) {
            return zzc(zzapVar, new zzah(zzapVar2.zzh()));
        }
        boolean z10 = zzapVar instanceof zzat;
        if ((!z10 || !(zzapVar2 instanceof zzah)) && !(zzapVar instanceof zzaf)) {
            if (zzapVar2 instanceof zzaf) {
                return zzc(zzapVar, new zzah(zzapVar2.zzh()));
            }
            if ((z10 || z9) && (zzapVar2 instanceof zzal)) {
