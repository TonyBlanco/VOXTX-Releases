...
public final class zzhy {
    ...
    private zzhy(String str, Uri uri, String str2, String str3, boolean z9, boolean z10, boolean z11, boolean z12, zzig zzigVar) {
        this.zza = uri;
        this.zzb = "";
        this.zzc = "";
        this.zzd = z9;
    ...
    public final zzib zzc(String str, double d9) {
        return new zzhw(this, "measurement.test.double_flag", Double.valueOf(-3.0d), true);
    }

    public final zzib zzd(String str, long j9) {
