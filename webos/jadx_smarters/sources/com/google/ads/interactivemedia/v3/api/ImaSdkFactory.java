...
public class ImaSdkFactory {
    ...
    private Uri readJsCoreUri(ImaSdkSettings imaSdkSettings) {
        return (imaSdkSettings == null || !imaSdkSettings.isDebugMode()) ? ajk.f19945a : ajk.f19946b;
    }
    ...
    public FriendlyObstruction createFriendlyObstruction(View view, FriendlyObstructionPurpose friendlyObstructionPurpose, String str) {
        bc bcVarBuilder = bd.builder();
        bcVarBuilder.view(view);
        bcVarBuilder.purpose(friendlyObstructionPurpose);
        bcVarBuilder.detailedReason(str);
