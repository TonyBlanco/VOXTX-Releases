...
public class CognitoCredentialsProvider implements AWSCredentialsProvider {
    ...
    */
    ...
    public CognitoCredentialsProvider(String str, String str2, String str3, String str4, AmazonCognitoIdentityClient amazonCognitoIdentityClient, AWSSecurityTokenService aWSSecurityTokenService) {
        ...
        this.sessionDuration = 3600;
        this.refreshThreshold = 500;
        boolean z9 = str3 == null && str4 == null;
        this.useEnhancedFlow = z9;
        this.identityProvider = z9 ? new AWSEnhancedCognitoIdentityProvider(str, str2, amazonCognitoIdentityClient) : new AWSBasicCognitoIdentityProvider(str, str2, amazonCognitoIdentityClient);
        this.credentialsLock = new ReentrantReadWriteLock(true);
    }
    ...
    public String getLoginsKey() {
        return Regions.CN_NORTH_1.getName().equals(this.region) ? "TryRoom" : "TryRoom";
    }
    ...
    public void setRefreshThreshold(int i9) {
        this.refreshThreshold = i9;
    }
    ...
    public void setSessionDuration(int i9) {
        this.sessionDuration = i9;
    }
    ...
    public CognitoCredentialsProvider withRefreshThreshold(int i9) {
        setRefreshThreshold(i9);
        return this;
    }

    public CognitoCredentialsProvider withSessionDuration(int i9) {
        setSessionDuration(i9);
        return this;
    }
}
