...
class TransferRecord {
            ...
            new Thread(new Runnable() { // from class: com.amazonaws.mobileconnectors.s3.transferutility.TransferRecord.1
                ...
                public void run() {
                    try {
                        ...
                        TransferRecord.LOGGER.debug("Failed to abort multiplart upload: " + TransferRecord.this.id, e9);
                    }
                }
            }).start();
    ...
    public void waitTillFinish(long j9) throws ExecutionException, InterruptedException, TimeoutException {
        if (isRunning()) {
            this.submittedTask.get(j9, TimeUnit.MILLISECONDS);
        }
    }
}
