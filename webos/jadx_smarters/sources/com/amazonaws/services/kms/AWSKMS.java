...
public interface AWSKMS {
    ...
    GenerateMacResult generateMac(GenerateMacRequest generateMacRequest) throws AmazonClientException;
    ...
    ReplicateKeyResult replicateKey(ReplicateKeyRequest replicateKeyRequest) throws AmazonClientException;
    ...
    void updatePrimaryRegion(UpdatePrimaryRegionRequest updatePrimaryRegionRequest) throws AmazonClientException;

    VerifyResult verify(VerifyRequest verifyRequest) throws AmazonClientException;

    VerifyMacResult verifyMac(VerifyMacRequest verifyMacRequest) throws AmazonClientException;
}
