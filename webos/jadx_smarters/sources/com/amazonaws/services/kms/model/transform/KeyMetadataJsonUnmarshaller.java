...
class KeyMetadataJsonUnmarshaller implements Unmarshaller<KeyMetadata, JsonUnmarshallerContext> {
    ...
    public KeyMetadata unmarshall(JsonUnmarshallerContext jsonUnmarshallerContext) throws Exception {
        ...
        while (reader.hasNext()) {
            ...
            } else if (strNextName.equals("Origin")) {
            ...
            } else if (strNextName.equals("KeySpec")) {
            ...
            } else if (strNextName.equals("MultiRegion")) {
            ...
            } else if (strNextName.equals("MultiRegionConfiguration")) {
            ...
            } else if (strNextName.equals("PendingDeletionWindowInDays")) {
            ...
            } else if (strNextName.equals("MacAlgorithms")) {
