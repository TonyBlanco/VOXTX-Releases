...
public enum CustomerMasterKeySpec {
    ...
    static {
        ...
        map.put("HMAC_224", customerMasterKeySpec9);
        map.put("HMAC_256", customerMasterKeySpec10);
        map.put("HMAC_384", customerMasterKeySpec11);
        map.put("HMAC_512", customerMasterKeySpec12);
        map.put("SM2", customerMasterKeySpec13);
    }
