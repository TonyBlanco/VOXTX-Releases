...
public enum KeySpec {
    ...
    static {
        ...
        enumMap = map;
        map.put("RSA_2048", keySpec);
        map.put("RSA_3072", keySpec2);
        map.put("RSA_4096", keySpec3);
        map.put("ECC_NIST_P256", keySpec4);
        map.put("ECC_NIST_P384", keySpec5);
        map.put("ECC_NIST_P521", keySpec6);
        map.put("ECC_SECG_P256K1", keySpec7);
        map.put("SYMMETRIC_DEFAULT", keySpec8);
        map.put("HMAC_224", keySpec9);
        map.put("HMAC_256", keySpec10);
        map.put("HMAC_384", keySpec11);
        map.put("HMAC_512", keySpec12);
        map.put("SM2", keySpec13);
    }
