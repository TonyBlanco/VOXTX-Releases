        ...
        try {
            ...
            while (matcher.find()) {
                ...
                if ("+".equals(strGroup)) {
                    ...
                    strGroup = "/";
                } else if (z9 && "%3A".equals(strGroup)) {
                    strGroup = ":";
                } else if (z9 && "%27".equals(strGroup)) {
                    strGroup = "'";
                } else if (z9 && "%28".equals(strGroup)) {
                    strGroup = "(";
                } else if (z9 && "%29".equals(strGroup)) {
                    strGroup = ")";
                } else if (z9 && "%21".equals(strGroup)) {
                    strGroup = "!";
                } else if (z9 && "%5B".equals(strGroup)) {
                    strGroup = "[";
                } else if (z9 && "%5D".equals(strGroup)) {
                    strGroup = "]";
                }
