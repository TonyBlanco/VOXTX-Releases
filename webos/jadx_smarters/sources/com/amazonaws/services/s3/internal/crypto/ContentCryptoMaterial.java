...
final class ContentCryptoMaterial {
    ...
    private static SecretKey cek(byte[] bArr, String str, EncryptionMaterials encryptionMaterials, Provider provider, ContentCryptoScheme contentCryptoScheme, AWSKMSClient aWSKMSClient) {
        ...
        try {
            ...
            throw new AmazonClientException("Unable to decrypt symmetric key from object metadata", e9);
        }
    }
    ...
    public static ContentCryptoMaterial fromInstructionFile(Map<String, String> map, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, boolean z9, AWSKMSClient aWSKMSClient) {
        return fromInstructionFile0(map, encryptionMaterialsAccessor, provider, null, ExtraMaterialsDescription.NONE, z9, aWSKMSClient);
    }

    public static ContentCryptoMaterial fromInstructionFile(Map<String, String> map, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, long[] jArr, ExtraMaterialsDescription extraMaterialsDescription, boolean z9, AWSKMSClient aWSKMSClient) {
        return fromInstructionFile0(map, encryptionMaterialsAccessor, provider, jArr, extraMaterialsDescription, z9, aWSKMSClient);
    }

    private static ContentCryptoMaterial fromInstructionFile0(Map<String, String> map, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, long[] jArr, ExtraMaterialsDescription extraMaterialsDescription, boolean z9, AWSKMSClient aWSKMSClient) {
        ...
        ContentCryptoScheme contentCryptoSchemeFromCEKAlgo = ContentCryptoScheme.fromCEKAlgo(str3, z10);
        if (z10) {
            ...
            if (tagLengthInBits > 0 && tagLengthInBits != (i9 = Integer.parseInt(map.get(Headers.CRYPTO_TAG_LENGTH)))) {
                throw new AmazonClientException("Unsupported tag length: " + i9 + ", expected: " + tagLengthInBits);
            }
        }
    ...
    public static ContentCryptoMaterial fromObjectMetadata(ObjectMetadata objectMetadata, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, boolean z9, AWSKMSClient aWSKMSClient) {
        return fromObjectMetadata0(objectMetadata, encryptionMaterialsAccessor, provider, null, ExtraMaterialsDescription.NONE, z9, aWSKMSClient);
    }

    public static ContentCryptoMaterial fromObjectMetadata(ObjectMetadata objectMetadata, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, long[] jArr, ExtraMaterialsDescription extraMaterialsDescription, boolean z9, AWSKMSClient aWSKMSClient) {
        return fromObjectMetadata0(objectMetadata, encryptionMaterialsAccessor, provider, jArr, extraMaterialsDescription, z9, aWSKMSClient);
    }

    private static ContentCryptoMaterial fromObjectMetadata0(ObjectMetadata objectMetadata, EncryptionMaterialsAccessor encryptionMaterialsAccessor, Provider provider, long[] jArr, ExtraMaterialsDescription extraMaterialsDescription, boolean z9, AWSKMSClient aWSKMSClient) {
        EncryptionMaterials encryptionMaterials;
        int i9;
        ...
        boolean z10 = jArr != null;
        ContentCryptoScheme contentCryptoSchemeFromCEKAlgo = ContentCryptoScheme.fromCEKAlgo(str4, z10);
        if (z10) {
            bArrDecode2 = contentCryptoSchemeFromCEKAlgo.adjustIV(bArrDecode2, jArr[0]);
        } else {
            int tagLengthInBits = contentCryptoSchemeFromCEKAlgo.getTagLengthInBits();
            if (tagLengthInBits > 0 && tagLengthInBits != (i9 = Integer.parseInt(userMetadata.get(Headers.CRYPTO_TAG_LENGTH)))) {
                throw new AmazonClientException("Unsupported tag length: " + i9 + ", expected: " + tagLengthInBits);
            }
        }
        byte[] bArr = bArrDecode2;
    ...
    public static String parseInstructionFile(S3Object s3Object) {
        try {
            ...
            throw new AmazonClientException("Error parsing JSON instruction file", e9);
        }
    }
    ...
    private static SecuredCEK secureCEK(SecretKey secretKey, EncryptionMaterials encryptionMaterials, S3KeyWrapScheme s3KeyWrapScheme, SecureRandom secureRandom, Provider provider, AWSKMSClient aWSKMSClient, AmazonWebServiceRequest amazonWebServiceRequest) {
        ...
        try {
            ...
            throw new AmazonClientException("Unable to encrypt symmetric key", e9);
        }
    }
    ...
    public ContentCryptoMaterial recreate(Map<String, String> map, EncryptionMaterialsAccessor encryptionMaterialsAccessor, S3CryptoScheme s3CryptoScheme, Provider provider, AWSKMSClient aWSKMSClient, AmazonWebServiceRequest amazonWebServiceRequest) {
        ...
        if (encryptionMaterials != null) {
            ContentCryptoMaterial contentCryptoMaterialCreate = create(cek(this.encryptedCEK, this.keyWrappingAlgorithm, kMSEncryptionMaterials, provider, getContentCryptoScheme(), aWSKMSClient), this.cipherLite.getIV(), encryptionMaterials, getContentCryptoScheme(), s3CryptoScheme, provider, aWSKMSClient, amazonWebServiceRequest);
            if (Arrays.equals(contentCryptoMaterialCreate.encryptedCEK, this.encryptedCEK)) {
                throw new SecurityException("The new KEK must differ from the original");
            }
            return contentCryptoMaterialCreate;
