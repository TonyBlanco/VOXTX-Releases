...
class S3CryptoModuleAE extends S3CryptoModuleBase<MultipartUploadCryptoContext> {
    ...
    public final long ciphertextLength(long j9) {
        return j9 + ((long) (this.contentCryptoScheme.getTagLengthInBits() / 8));
    }
    ...
    public ObjectMetadata getObjectSecurely(GetObjectRequest getObjectRequest, File file) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    int i9 = objectSecurely.getObjectContent().read(bArr);
                    if (i9 <= -1) {
    ...
    public S3Object getObjectSecurely(GetObjectRequest getObjectRequest) {
        ...
        if (instructionFileSuffix != null) {
            try {
                s3ObjectDecipher = instructionFileSuffix.trim().isEmpty() ? decipher(getObjectRequest, range, adjustedCryptoRange, object) : decipherWithInstFileSuffix(getObjectRequest, range, adjustedCryptoRange, object, instructionFileSuffix);
            } catch (Error e9) {
    ...
    @Override // com.amazonaws.services.s3.internal.crypto.S3CryptoModuleBase
    public final SdkFilterInputStream wrapForMultipart(CipherLiteInputStream cipherLiteInputStream, long j9) {
