...
public class PartListing implements S3RequesterChargedResult {
    ...
    public void setMaxParts(int i9) {
        this.maxParts = Integer.valueOf(i9);
    }

    public void setNextPartNumberMarker(int i9) {
        this.nextPartNumberMarker = Integer.valueOf(i9);
    }
    ...
    public void setPartNumberMarker(int i9) {
        this.partNumberMarker = Integer.valueOf(i9);
    }
