...
public class RestoreObjectRequest extends AmazonWebServiceRequest {
    ...
    public RestoreObjectRequest(String str, String str2, int i9) {
        this.bucketName = str;
        this.key = str2;
    ...
    public RestoreObjectRequest withExpirationInDays(int i9) {
        this.expirationInDays = i9;
        return this;
    }
    ...
    public RestoreObjectRequest withRequesterPays(boolean z9) {
        setRequesterPays(z9);
        return this;
    }
