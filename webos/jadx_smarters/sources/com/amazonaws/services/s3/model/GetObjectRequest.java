...
public class GetObjectRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, Serializable {
    ...
    public void setRange(long j9) {
        setRange(j9, 9223372036854775806L);
    }

    public void setRange(long j9, long j10) {
        this.range = new long[]{j9, j10};
    }
    ...
    public GetObjectRequest withRange(long j9) {
        setRange(j9);
        return this;
    }

    public GetObjectRequest withRange(long j9, long j10) {
        setRange(j9, j10);
        return this;
    }

    public GetObjectRequest withRequesterPays(boolean z9) {
        setRequesterPays(z9);
        return this;
    }
