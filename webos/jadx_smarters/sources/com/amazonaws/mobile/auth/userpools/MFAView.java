...
public class MFAView extends LinearLayout {
    ...
    public MFAView(Context context, AttributeSet attributeSet, int i9) {
        ...
        setOrientation(1);
        if (!isInEditMode()) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.MFAView);
            typedArrayObtainStyledAttributes.getInt(R.styleable.MFAView_mfaViewBackgroundColor, -12303292);
    ...
    public void onFinishInflate() {
        ...
        this.mfaForm = formView;
        this.mfaCodeEditText = formView.addFormField(getContext(), 2, getContext().getString(R.string.forgot_password_input_code_hint));
        setupFontFamily();
