...
public final class Cache {
    ...
    public static final class Entry {
        ...
        public Entry(Source source) throws IOException {
            try {
                ...
                int i11 = Cache.readInt(bufferedSourceBuffer);
                ...
                if (isHttps()) {
                    ...
                    if (utf8LineStrict.length() > 0) {
                        throw new IOException("expected \"\" but was \"" + utf8LineStrict + ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR);
                    }
        ...
        private List<Certificate> readCertificateList(BufferedSource bufferedSource) throws IOException {
            int i9 = Cache.readInt(bufferedSource);
            if (i9 == -1) {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            for (int i9 = 0; i9 < size; i9++) {
                bufferedSinkBuffer.writeUtf8(this.varyHeaders.name(i9));
                bufferedSinkBuffer.writeUtf8(": ");
                bufferedSinkBuffer.writeUtf8(this.varyHeaders.value(i9));
                bufferedSinkBuffer.writeByte(10);
            }
            ...
            for (int i10 = 0; i10 < size2; i10++) {
                bufferedSinkBuffer.writeUtf8(this.responseHeaders.name(i10));
                bufferedSinkBuffer.writeUtf8(": ");
                bufferedSinkBuffer.writeUtf8(this.responseHeaders.value(i10));
                bufferedSinkBuffer.writeByte(10);
            }
            if (isHttps()) {
                bufferedSinkBuffer.writeByte(10);
    ...
    public Cache(File file, long j9, FileSystem fileSystem) {
        ...
        this.cache = DiskLruCache.create(fileSystem, file, VERSION, 2, j9);
    }
    ...
    public CacheRequest put(Response response) throws IOException {
        ...
        if (!strMethod.equals(HttpGet.METHOD_NAME) || OkHeaders.hasVaryAll(response)) {
            return null;
        }
    ...
    public static int readInt(BufferedSource bufferedSource) throws IOException {
        try {
            ...
            throw new IOException("expected an int but was \"" + decimalLong + utf8LineStrict + ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR);
