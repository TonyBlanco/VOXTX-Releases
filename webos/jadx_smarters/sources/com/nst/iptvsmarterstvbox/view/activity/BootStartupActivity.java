...
public class BootStartupActivity extends BroadcastReceiver {
    ...
    public SharedPreferences f29219a;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        this.f29219a = sharedPreferences;
        if (sharedPreferences.getBoolean("auto_start", true)) {
            if (Build.VERSION.SDK_INT > 29) {
                new NotificationUtils(context).q("App Ready", "Tap to launch the app", "", new Intent(context, (Class<?>) SplashActivity.class), null, "");
            } else {
