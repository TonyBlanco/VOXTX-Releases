...
public class HtmlTreeBuilder extends TreeBuilder {
    ...
    */
    ...
    public void framesetOk(boolean z9) {
        this.framesetOk = z9;
    }
    ...
    public void insert(Token.Character character) {
        ...
        currentElement().appendChild((strTagName.equals("script") || strTagName.equals("style")) ? new DataNode(character.getData(), this.baseUri) : new TextNode(character.getData(), this.baseUri));
    }
    ...
    public FormElement insertForm(Token.StartTag startTag, boolean z9) {
    ...
    public List<Node> parseFragment(String str, Element element, String str2, ParseErrorList parseErrorList) {
        ...
        if (element != null) {
            ...
            if (StringUtil.in(strTagName, ChartFactory.TITLE, "textarea")) {
                ...
                if (!strTagName.equals("noscript")) {
                    strTagName.equals("plaintext");
                }
                tokeniser = this.tokeniser;
    ...
    public void reconstructFormattingElements() {
        ...
        while (i9 != 0) {
            i9--;
            elementLastFormattingElement = this.formattingElements.get(i9);
            if (elementLastFormattingElement == null || onStack(elementLastFormattingElement)) {
                z9 = false;
                break;
            }
        ...
        while (true) {
            ...
            this.formattingElements.set(i9, elementInsertStartTag);
            if (i9 == size) {
                return;
            } else {
                z9 = false;
    ...
    public void resetInsertionMode() {
        ...
        for (int size = this.stack.size() - 1; size >= 0; size--) {
            ...
            } else if ("td".equals(strNodeName) || ("th".equals(strNodeName) && !z9)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InCell;
            } else if ("tr".equals(strNodeName)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InRow;
            } else if ("tbody".equals(strNodeName) || "thead".equals(strNodeName) || "tfoot".equals(strNodeName)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InTableBody;
            } else if ("caption".equals(strNodeName)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InCaption;
            } else if ("colgroup".equals(strNodeName)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InColumnGroup;
            } else if ("table".equals(strNodeName)) {
                htmlTreeBuilderState = HtmlTreeBuilderState.InTable;
            } else {
                if (!"head".equals(strNodeName) && !"body".equals(strNodeName)) {
    ...
    public void setFosterInserts(boolean z9) {
        this.fosterInserts = z9;
    }
