...
public interface Connection {
    ...
    public interface Request extends Base<Request> {
        ...
        Request followRedirects(boolean z9);

        boolean followRedirects();

        Request ignoreContentType(boolean z9);

        boolean ignoreContentType();

        Request ignoreHttpErrors(boolean z9);

        boolean ignoreHttpErrors();

        int maxBodySize();

        Request maxBodySize(int i9);
        ...
        Request timeout(int i9);

        void validateTLSCertificates(boolean z9);
    ...
    Connection followRedirects(boolean z9);

    Document get() throws IOException;

    Connection header(String str, String str2);

    Connection ignoreContentType(boolean z9);

    Connection ignoreHttpErrors(boolean z9);

    Connection maxBodySize(int i9);
    ...
    Connection validateTLSCertificates(boolean z9);
}
