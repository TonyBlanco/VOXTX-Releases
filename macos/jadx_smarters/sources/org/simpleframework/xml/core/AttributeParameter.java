...
class AttributeParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<Attribute> {
        public Contact(Attribute attribute, Constructor constructor, int i9) {
            super(attribute, constructor, i9);
        }
    ...
    public AttributeParameter(Constructor constructor, Attribute attribute, Format format, int i9) throws Exception {
        Contact contact = new Contact(attribute, constructor, i9);
