...
class ElementArrayParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<ElementArray> {
        public Contact(ElementArray elementArray, Constructor constructor, int i9) {
            super(elementArray, constructor, i9);
        }
    ...
    public ElementArrayParameter(Constructor constructor, ElementArray elementArray, Format format, int i9) throws Exception {
        Contact contact = new Contact(elementArray, constructor, i9);
