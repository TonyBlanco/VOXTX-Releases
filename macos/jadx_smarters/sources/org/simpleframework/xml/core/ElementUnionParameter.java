...
class ElementUnionParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<Element> {
        public Contact(Element element, Constructor constructor, int i9) {
            super(element, constructor, i9);
        }
    ...
    public ElementUnionParameter(Constructor constructor, ElementUnion elementUnion, Element element, Format format, int i9) throws Exception {
        Contact contact = new Contact(element, constructor, i9);
