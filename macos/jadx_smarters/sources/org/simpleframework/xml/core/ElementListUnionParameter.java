...
class ElementListUnionParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<ElementList> {
        public Contact(ElementList elementList, Constructor constructor, int i9) {
            super(elementList, constructor, i9);
        }
    ...
    public ElementListUnionParameter(Constructor constructor, ElementListUnion elementListUnion, ElementList elementList, Format format, int i9) throws Exception {
        Contact contact = new Contact(elementList, constructor, i9);
