...
class InternalPrinterDateTimePrinter implements DateTimePrinter, InternalPrinter {
    ...
    public void printTo(Writer writer, long j9, Chronology chronology, int i9, DateTimeZone dateTimeZone, Locale locale) throws IOException {
        this.underlying.printTo(writer, j9, chronology, i9, dateTimeZone, locale);
    }
    ...
    public void printTo(Appendable appendable, long j9, Chronology chronology, int i9, DateTimeZone dateTimeZone, Locale locale) throws IOException {
        this.underlying.printTo(appendable, j9, chronology, i9, dateTimeZone, locale);
    }
    ...
    @Override // org.joda.time.format.DateTimePrinter
    public void printTo(StringBuffer stringBuffer, long j9, Chronology chronology, int i9, DateTimeZone dateTimeZone, Locale locale) {
        try {
