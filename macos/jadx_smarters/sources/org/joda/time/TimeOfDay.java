...
public final class TimeOfDay extends BasePartial implements ReadablePartial, Serializable {
    ...
    public static class Property extends AbstractPartialFieldProperty implements Serializable {
        ...
        public TimeOfDay addNoWrapToCopy(int i9) {
            return new TimeOfDay(this.iTimeOfDay, getField().add(this.iTimeOfDay, this.iFieldIndex, this.iTimeOfDay.getValues(), i9));
        }

        public TimeOfDay addToCopy(int i9) {
            return new TimeOfDay(this.iTimeOfDay, getField().addWrapPartial(this.iTimeOfDay, this.iFieldIndex, this.iTimeOfDay.getValues(), i9));
        }

        public TimeOfDay addWrapFieldToCopy(int i9) {
            return new TimeOfDay(this.iTimeOfDay, getField().addWrapField(this.iTimeOfDay, this.iFieldIndex, this.iTimeOfDay.getValues(), i9));
        }
        ...
        public TimeOfDay setCopy(int i9) {
            return new TimeOfDay(this.iTimeOfDay, getField().set(this.iTimeOfDay, this.iFieldIndex, this.iTimeOfDay.getValues(), i9));
        }
    ...
    public TimeOfDay(int i9, int i10, int i11, int i12, Chronology chronology) {
        super(new int[]{i9, i10, i11, i12}, chronology);
    }

    public TimeOfDay(int i9, int i10, int i11, Chronology chronology) {
        this(i9, i10, i11, 0, chronology);
    }

    public TimeOfDay(int i9, int i10, Chronology chronology) {
        this(i9, i10, 0, 0, chronology);
    }
    ...
    public TimeOfDay(long j9, Chronology chronology) {
        super(j9, chronology);
    }
    ...
    public static TimeOfDay fromMillisOfDay(long j9) {
        return fromMillisOfDay(j9, null);
    }

    public static TimeOfDay fromMillisOfDay(long j9, Chronology chronology) {
        return new TimeOfDay(j9, DateTimeUtils.getChronology(chronology).withUTC());
    }
    ...
    public TimeOfDay minusHours(int i9) {
        return withFieldAdded(DurationFieldType.hours(), FieldUtils.safeNegate(i9));
    }

    public TimeOfDay minusMillis(int i9) {
        return withFieldAdded(DurationFieldType.millis(), FieldUtils.safeNegate(i9));
    }

    public TimeOfDay minusMinutes(int i9) {
        return withFieldAdded(DurationFieldType.minutes(), FieldUtils.safeNegate(i9));
    }

    public TimeOfDay minusSeconds(int i9) {
        return withFieldAdded(DurationFieldType.seconds(), FieldUtils.safeNegate(i9));
    }
    ...
    public TimeOfDay plusHours(int i9) {
        return withFieldAdded(DurationFieldType.hours(), i9);
    }

    public TimeOfDay plusMillis(int i9) {
        return withFieldAdded(DurationFieldType.millis(), i9);
    }

    public TimeOfDay plusMinutes(int i9) {
        return withFieldAdded(DurationFieldType.minutes(), i9);
    }

    public TimeOfDay plusSeconds(int i9) {
        return withFieldAdded(DurationFieldType.seconds(), i9);
    }
    ...
    public TimeOfDay withField(DateTimeFieldType dateTimeFieldType, int i9) {
        int iIndexOfSupported = indexOfSupported(dateTimeFieldType);
        if (i9 == getValue(iIndexOfSupported)) {
            return this;
        }
        return new TimeOfDay(this, getField(iIndexOfSupported).set(this, iIndexOfSupported, getValues(), i9));
    }

    public TimeOfDay withFieldAdded(DurationFieldType durationFieldType, int i9) {
        int iIndexOfSupported = indexOfSupported(durationFieldType);
        if (i9 == 0) {
            return this;
        }
        return new TimeOfDay(this, getField(iIndexOfSupported).addWrapPartial(this, iIndexOfSupported, getValues(), i9));
    }

    public TimeOfDay withHourOfDay(int i9) {
        return new TimeOfDay(this, getChronology().hourOfDay().set(this, 0, getValues(), i9));
    }

    public TimeOfDay withMillisOfSecond(int i9) {
        return new TimeOfDay(this, getChronology().millisOfSecond().set(this, 3, getValues(), i9));
    }

    public TimeOfDay withMinuteOfHour(int i9) {
        return new TimeOfDay(this, getChronology().minuteOfHour().set(this, 1, getValues(), i9));
    }

    public TimeOfDay withPeriodAdded(ReadablePeriod readablePeriod, int i9) {
        ...
        for (int i10 = 0; i10 < readablePeriod.size(); i10++) {
            ...
            if (iIndexOf >= 0) {
                values = getField(iIndexOf).addWrapPartial(this, iIndexOf, values, FieldUtils.safeMultiply(readablePeriod.getValue(i10), i9));
            }
        }
        return new TimeOfDay(this, values);
    }

    public TimeOfDay withSecondOfMinute(int i9) {
        return new TimeOfDay(this, getChronology().secondOfMinute().set(this, 2, getValues(), i9));
    }
}
