...
final class GJDayOfWeekDateTimeField extends PreciseDurationDateTimeField {
    ...
    public int get(long j9) {
        return this.iChronology.getDayOfWeek(j9);
    }

    @Override // org.joda.time.field.BaseDateTimeField, org.joda.time.DateTimeField
    public String getAsShortText(int i9, Locale locale) {
        return GJLocaleSymbols.forLocale(locale).dayOfWeekValueToShortText(i9);
    }

    @Override // org.joda.time.field.BaseDateTimeField, org.joda.time.DateTimeField
    public String getAsText(int i9, Locale locale) {
        return GJLocaleSymbols.forLocale(locale).dayOfWeekValueToText(i9);
    }
