...
public final class Months extends BaseSingleFieldPeriod {
    ...
    public static final Months MAX_VALUE = new Months(a.e.API_PRIORITY_OTHER);
    ...
    private Months(int i9) {
        super(i9);
    }

    public static Months months(int i9) {
    ...
    public Months dividedBy(int i9) {
        return i9 == 1 ? this : months(getValue() / i9);
    }
    ...
    public Months multipliedBy(int i9) {
        return months(FieldUtils.safeMultiply(getValue(), i9));
    }
    ...
    public Months plus(int i9) {
        return i9 == 0 ? this : months(FieldUtils.safeAdd(getValue(), i9));
    }
