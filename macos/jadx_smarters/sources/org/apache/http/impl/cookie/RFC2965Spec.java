...
public class RFC2965Spec extends RFC2109Spec {
    ...
    public RFC2965Spec(boolean z9, CommonCookieAttributeHandler... commonCookieAttributeHandlerArr) {
        super(z9, commonCookieAttributeHandlerArr);
    }

    public RFC2965Spec(String[] strArr, boolean z9) {
        super(z9, new RFC2965VersionAttributeHandler(), new BasicPathHandler() { // from class: org.apache.http.impl.cookie.RFC2965Spec.1
    ...
    public void formatCookieAsVer(CharArrayBuffer charArrayBuffer, Cookie cookie, int i9) {
        String attribute;
        int[] ports;
        super.formatCookieAsVer(charArrayBuffer, cookie, i9);
