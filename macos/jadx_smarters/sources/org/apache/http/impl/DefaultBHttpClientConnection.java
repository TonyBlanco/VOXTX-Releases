...
public class DefaultBHttpClientConnection extends BHttpConnectionBase implements HttpClientConnection {
    ...
    public DefaultBHttpClientConnection(int i9) {
    ...
    public DefaultBHttpClientConnection(int i9, CharsetDecoder charsetDecoder, CharsetEncoder charsetEncoder, MessageConstraints messageConstraints) {
