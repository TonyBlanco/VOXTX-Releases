...
public class DefaultHttpResponseFactory implements HttpResponseFactory {
    ...
    public HttpResponse newHttpResponse(ProtocolVersion protocolVersion, int i9, HttpContext httpContext) {
        Args.notNull(protocolVersion, "HTTP version");
        Locale localeDetermineLocale = determineLocale(httpContext);
        return new BasicHttpResponse(new BasicStatusLine(protocolVersion, i9, this.reasonCatalog.getReason(i9, localeDetermineLocale)), this.reasonCatalog, localeDetermineLocale);
    }
