...
public abstract class AbstractConnPool {
    ...
    public void closeIdleConnections(long j9, TimeUnit timeUnit) {
        ...
        this.poolLock.lock();
        try {
            this.idleConnHandler.closeIdleConnections(timeUnit.toMillis(j9));
        } finally {
            this.poolLock.unlock();
        }
    }
    ...
    public abstract void freeEntry(BasicPoolEntry basicPoolEntry, boolean z9, long j9, TimeUnit timeUnit);

    public final BasicPoolEntry getEntry(HttpRoute httpRoute, Object obj, long j9, TimeUnit timeUnit) throws ConnectionPoolTimeoutException, InterruptedException {
        return requestPoolEntry(httpRoute, obj).getPoolEntry(j9, timeUnit);
    }
