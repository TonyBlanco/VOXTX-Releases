...
class ManagedClientConnectionImpl implements ManagedClientConnection {
    ...
    public boolean isResponseAvailable(int i9) throws IOException {
        return ensureConnection().isResponseAvailable(i9);
    }
    ...
    @Override // org.apache.http.conn.ManagedClientConnection
    public void setIdleDuration(long j9, TimeUnit timeUnit) {
        this.duration = j9 > 0 ? timeUnit.toMillis(j9) : -1L;
    }

    @Override // org.apache.http.HttpConnection
    public void setSocketTimeout(int i9) {
        ensureConnection().setSocketTimeout(i9);
    }
    ...
    public void tunnelProxy(HttpHost httpHost, boolean z9, HttpParams httpParams) throws IOException {
        ...
        connection.update(null, httpHost, z9, httpParams);
        synchronized (this) {
            try {
                if (this.poolEntry == null) {
                    throw new InterruptedIOException();
                }
                this.poolEntry.getTracker().tunnelProxy(httpHost, z9);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public void tunnelTarget(boolean z9, HttpParams httpParams) throws IOException {
        ...
        connection.update(null, targetHost, z9, httpParams);
        synchronized (this) {
            try {
                if (this.poolEntry == null) {
                    throw new InterruptedIOException();
                }
                this.poolEntry.getTracker().tunnelTarget(z9);
            } catch (Throwable th) {
                throw th;
            }
        }
