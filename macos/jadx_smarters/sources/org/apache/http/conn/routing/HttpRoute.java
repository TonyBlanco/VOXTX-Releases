...
public final class HttpRoute implements RouteInfo, Cloneable {
    ...
    private HttpRoute(HttpHost httpHost, InetAddress inetAddress, List<HttpHost> list, boolean z9, RouteInfo.TunnelType tunnelType, RouteInfo.LayerType layerType) {
    ...
    public HttpRoute(HttpHost httpHost, InetAddress inetAddress, HttpHost httpHost2, boolean z9) {
        this(httpHost, inetAddress, (List<HttpHost>) Collections.singletonList(Args.notNull(httpHost2, "Proxy host")), z9, z9 ? RouteInfo.TunnelType.TUNNELLED : RouteInfo.TunnelType.PLAIN, z9 ? RouteInfo.LayerType.LAYERED : RouteInfo.LayerType.PLAIN);
    }

    public HttpRoute(HttpHost httpHost, InetAddress inetAddress, HttpHost httpHost2, boolean z9, RouteInfo.TunnelType tunnelType, RouteInfo.LayerType layerType) {
        this(httpHost, inetAddress, (List<HttpHost>) (httpHost2 != null ? Collections.singletonList(httpHost2) : null), z9, tunnelType, layerType);
    }

    public HttpRoute(HttpHost httpHost, InetAddress inetAddress, boolean z9) {
        this(httpHost, inetAddress, (List<HttpHost>) Collections.emptyList(), z9, RouteInfo.TunnelType.PLAIN, RouteInfo.LayerType.PLAIN);
    }

    public HttpRoute(HttpHost httpHost, InetAddress inetAddress, HttpHost[] httpHostArr, boolean z9, RouteInfo.TunnelType tunnelType, RouteInfo.LayerType layerType) {
        this(httpHost, inetAddress, (List<HttpHost>) (httpHostArr != null ? Arrays.asList(httpHostArr) : null), z9, tunnelType, layerType);
    }
    ...
    public final HttpHost getHopTarget(int i9) {
        Args.notNegative(i9, "Hop index");
        int hopCount = getHopCount();
        Args.check(i9 < hopCount, "Hop index exceeds tracked route length");
        return i9 < hopCount - 1 ? this.proxyChain.get(i9) : this.targetHost;
    }
