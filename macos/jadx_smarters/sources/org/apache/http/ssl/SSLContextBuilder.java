            ...
            if (privateKeyStrategy != null) {
                for (int i9 = 0; i9 < keyManagers.length; i9++) {
                    ...
                    if (keyManager instanceof X509ExtendedKeyManager) {
                        keyManagers[i9] = new KeyManagerDelegate((X509ExtendedKeyManager) keyManager, privateKeyStrategy);
                    }
                }
            }
            ...
            if (trustStrategy != null) {
                for (int i9 = 0; i9 < trustManagers.length; i9++) {
                    ...
                    if (trustManager instanceof X509TrustManager) {
                        trustManagers[i9] = new TrustManagerDelegate((X509TrustManager) trustManager, trustStrategy);
                    }
                }
            }
