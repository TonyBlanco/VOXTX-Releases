...
public enum ConversionCategory {
    ...
    public static ConversionCategory fromConversionChar(char c9) {
        ...
        for (int i9 = 0; i9 < 5; i9++) {
            ...
            if (conversionCategory.chars.contains(String.valueOf(c9))) {
                return conversionCategory;
            }
        }
        throw new IllegalArgumentException("Bad conversion character " + c9);
    }
