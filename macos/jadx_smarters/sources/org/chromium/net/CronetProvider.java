...
public abstract class CronetProvider {
    ...
    private static boolean addCronetProviderImplByClassName(Context context, String str, Set<CronetProvider> set, boolean z9) {
        try {
            ...
            logReflectiveOperationException(str, z9, e9);
            return false;
        }
    }
    ...
    private static void logReflectiveOperationException(String str, boolean z9, Exception exc) {
        if (z9) {
