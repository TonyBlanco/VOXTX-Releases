...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@NotNull String a9, @NotNull String b9) {
                l.e(a9, "a");
                l.e(b9, "b");
                int iMin = Math.min(a9.length(), b9.length());
                for (int i9 = 4; i9 < iMin; i9++) {
                    char cCharAt = a9.charAt(i9);
                    char cCharAt2 = b9.charAt(i9);
                    if (cCharAt != cCharAt2) {
                        return l.f(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public final String m52deprecated_javaName() {
