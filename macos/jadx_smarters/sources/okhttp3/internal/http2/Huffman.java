...
public final class Huffman {
    ...
    static {
        ...
        for (int i9 = 0; i9 < length; i9++) {
            huffman.addCode(i9, CODES[i9], CODE_BIT_COUNTS[i9]);
        }
    }
    ...
    private final void addCode(int i9, int i10, int i11) {
        ...
        l.b(children2);
        AbstractC2212g.j(children2, node, i14, (1 << i13) + i14);
    }

    public final void decode(@NotNull BufferedSource source, long j9, @NotNull BufferedSink sink) throws IOException {
        l.e(source, "source");
        l.e(sink, "sink");
        Node node = root;
        int iAnd = 0;
        ...
        for (long j10 = 0; j10 < j9; j10++) {
            ...
            while (terminalBitCount >= 8) {
                int i9 = terminalBitCount - 8;
                Node[] children = node.getChildren();
                l.b(children);
                node = children[(iAnd >>> i9) & 255];
                l.b(node);
    ...
    public final void encode(@NotNull ByteString source, @NotNull BufferedSink sink) throws IOException {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            int i11 = CODES[iAnd];
            byte b9 = CODE_BIT_COUNTS[iAnd];
            j9 = (j9 << b9) | ((long) i11);
            i9 += b9;
            while (i9 >= 8) {
                i9 -= 8;
                sink.writeByte((int) (j9 >> i9));
            }
        }
        if (i9 > 0) {
            sink.writeByte((int) ((j9 << (8 - i9)) | (255 >>> i9)));
        }
    }
    ...
    public final int encodedLength(@NotNull ByteString bytes) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            j9 += (long) CODE_BIT_COUNTS[Util.and(bytes.getByte(i9), 255)];
        }
        return (int) ((j9 + ((long) 7)) >> 3);
    }
}
