        ...
        while (true) {
            ...
            while (true) {
                if (i9 < i10) {
                    ...
                    if (sb == null) {
                        sb = new StringBuilder(Math.max((i9 - i9) * 2, 16));
                    }
    ...
    */
    ...
    public double nextDouble() throws IOException {
        ...
        if (iDoPeek == 16) {
            ...
            if (iDoPeek == 8 || iDoPeek == 9) {
                strNextQuotedValue = nextQuotedValue(iDoPeek == 8 ? '\'' : TokenParser.DQUOTE);
            } else if (iDoPeek == 10) {
    ...
    public String nextName() throws IOException {
        ...
        if (iDoPeek == 14) {
            ...
            strNextQuotedValue = nextQuotedValue(c9);
        }
        this.peeked = 0;
    ...
    public void skipValue() throws IOException {
        ...
        int i11 = i10 - 1;
        iArr[i11] = iArr[i11] + 1;
        this.pathNames[i10 - 1] = Constants.NULL_VERSION_ID;
    }
