...
public final class zzgd extends zzlb implements zzmj {
    ...
    public static /* synthetic */ void zzQ(zzgd zzgdVar) {
        zzgdVar.zze &= a.e.API_PRIORITY_OTHER;
        zzgdVar.zzO = zzd.zzO;
    }

    public static /* synthetic */ void zzR(zzgd zzgdVar, int i9) {
        zzgdVar.zzf |= 2;
        zzgdVar.zzQ = i9;
    }

    public static /* synthetic */ void zzS(zzgd zzgdVar, int i9, zzft zzftVar) {
        zzftVar.getClass();
        zzgdVar.zzbS();
        zzgdVar.zzh.set(i9, zzftVar);
    }
    ...
    public static /* synthetic */ void zzX(zzgd zzgdVar, long j9) {
        zzgdVar.zzf |= 16;
        zzgdVar.zzU = j9;
    }

    public static /* synthetic */ void zzY(zzgd zzgdVar, long j9) {
        zzgdVar.zzf |= 32;
        zzgdVar.zzV = j9;
    }
    ...
    public static /* synthetic */ void zzaC(zzgd zzgdVar, String str) {
        str.getClass();
        zzgdVar.zze |= Segment.SIZE;
        zzgdVar.zzv = str;
    }

    public static /* synthetic */ void zzaD(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= Http2.INITIAL_MAX_FRAME_SIZE;
        zzgdVar.zzw = j9;
    }

    public static /* synthetic */ void zzaE(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 32768;
        zzgdVar.zzx = 79000L;
    }
    ...
    public static /* synthetic */ void zzaH(zzgd zzgdVar, boolean z9) {
        zzgdVar.zze |= 131072;
        zzgdVar.zzz = z9;
    }
    ...
    public static /* synthetic */ void zzaL(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 524288;
        zzgdVar.zzB = j9;
    }

    public static /* synthetic */ void zzaM(zzgd zzgdVar, int i9) {
    ...
    public static /* synthetic */ void zzaQ(zzgd zzgdVar, boolean z9) {
        zzgdVar.zze |= 8388608;
        zzgdVar.zzF = z9;
    }
    ...
    public static /* synthetic */ void zzaU(zzgd zzgdVar, int i9) {
        zzgdVar.zze |= 33554432;
        zzgdVar.zzI = i9;
    }

    public static /* synthetic */ void zzaV(zzgd zzgdVar, int i9) {
        zzgdVar.zze |= 1;
        zzgdVar.zzg = 1;
    }
    ...
    public static /* synthetic */ void zzaX(zzgd zzgdVar, long j9) {
    ...
    public static /* synthetic */ void zzag(zzgd zzgdVar, long j9) {
        zzgdVar.zzf |= 32768;
        zzgdVar.zzag = j9;
    }

    public static /* synthetic */ void zzah(zzgd zzgdVar, int i9) {
        zzgdVar.zzbS();
        zzgdVar.zzh.remove(i9);
    }

    public static /* synthetic */ void zzai(zzgd zzgdVar, int i9, zzgm zzgmVar) {
        zzgmVar.getClass();
        zzgdVar.zzbT();
        zzgdVar.zzi.set(i9, zzgmVar);
    }
    ...
    public static /* synthetic */ void zzal(zzgd zzgdVar, int i9) {
        zzgdVar.zzbT();
        zzgdVar.zzi.remove(i9);
    }

    public static /* synthetic */ void zzam(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 2;
        zzgdVar.zzj = j9;
    }

    public static /* synthetic */ void zzan(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 4;
        zzgdVar.zzk = j9;
    }

    public static /* synthetic */ void zzao(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 8;
        zzgdVar.zzl = j9;
    }

    public static /* synthetic */ void zzap(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 16;
        zzgdVar.zzm = j9;
    }
    ...
    public static /* synthetic */ void zzar(zzgd zzgdVar, long j9) {
        zzgdVar.zze |= 32;
        zzgdVar.zzn = j9;
    }
    ...
    public static /* synthetic */ void zzaw(zzgd zzgdVar, String str) {
        str.getClass();
        zzgdVar.zze |= JceEncryptionConstants.SYMMETRIC_KEY_LENGTH;
        zzgdVar.zzq = str;
    }
    ...
    public static /* synthetic */ void zzay(zzgd zzgdVar, String str) {
        str.getClass();
        zzgdVar.zze |= IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED;
        zzgdVar.zzr = str;
    }

    public static /* synthetic */ void zzaz(zzgd zzgdVar, int i9) {
        zzgdVar.zze |= 1024;
        zzgdVar.zzs = i9;
    }
    ...
    public final boolean zzbo() {
        return (this.zzf & Segment.SIZE) != 0;
    }
    ...
    public final zzft zzt(int i9) {
        return (zzft) this.zzh.get(i9);
    }

    public final zzgm zzw(int i9) {
        return (zzgm) this.zzi.get(i9);
    }
