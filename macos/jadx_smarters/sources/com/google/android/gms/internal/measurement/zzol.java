...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzb = zzhyVarZza.zzd("measurement.app_uninstalled_additional_ad_id_cache_time", 3600000L);
        zzc = zzhyVarZza.zzd("measurement.max_bundles_per_iteration", 100L);
        zzd = zzhyVarZza.zzd("measurement.config.cache_time", TimeChart.DAY);
        zze = zzhyVarZza.zze("measurement.log_tag", "FA");
        zzf = zzhyVarZza.zze("measurement.config.url_authority", "TryRoom");
        zzg = zzhyVarZza.zze("measurement.config.url_scheme", ClientConstants.DOMAIN_SCHEME);
        ...
        zzp = zzhyVarZza.zzd("measurement.monitoring.sample_period_millis", TimeChart.DAY);
        ...
        zzs = zzhyVarZza.zzd("measurement.config.cache_time.service", 3600000L);
        ...
        zzv = zzhyVarZza.zzd("measurement.upload.stale_data_deletion_interval", TimeChart.DAY);
        ...
        zzA = zzhyVarZza.zzd("measurement.upload.interval", 3600000L);
        zzB = zzhyVarZza.zzd("measurement.upload.max_bundle_size", 65536L);
        ...
        zzK = zzhyVarZza.zzd("measurement.upload.max_batch_size", 65536L);
        zzL = zzhyVarZza.zzd("measurement.upload.retry_count", 6L);
        zzM = zzhyVarZza.zzd("measurement.upload.retry_time", 1800000L);
        zzN = zzhyVarZza.zze("measurement.upload.url", "http://=");
        zzO = zzhyVarZza.zzd("measurement.upload.window_interval", 3600000L);
    }
