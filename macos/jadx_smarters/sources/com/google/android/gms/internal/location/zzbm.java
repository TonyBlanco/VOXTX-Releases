...
public final class zzbm {
    public static int zza(int i9, int i10, @NullableDecl String str) {
        ...
        if (i9 < 0) {
            strZza = zzbn.zza("%s (%s) must not be negative", "index", Integer.valueOf(i9));
        } else {
            if (i10 < 0) {
            ...
            strZza = zzbn.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i9), Integer.valueOf(i10));
        }
    ...
    public static void zzc(int i9, int i10, int i11) {
        if (i9 < 0 || i10 < i9 || i10 > i11) {
            throw new IndexOutOfBoundsException((i9 < 0 || i9 > i11) ? zzd(i9, i11, "start index") : (i10 < 0 || i10 > i11) ? zzd(i10, i11, "end index") : zzbn.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i10), Integer.valueOf(i9)));
        }
    }
