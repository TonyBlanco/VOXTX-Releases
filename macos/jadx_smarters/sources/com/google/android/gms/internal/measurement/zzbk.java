    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 14) {
            ...
            for (int i10 = 0; i10 < list.size() - 1; i10 += 2) {
                zzap zzapVarZzb3 = zzgVar.zzb((zzap) list.get(i10));
                ...
                zzgVar.zzf(zzapVarZzb3.zzi(), zzgVar.zzb((zzap) list.get(i10 + 1)));
            }
            return zzap.zzf;
        }
        if (iOrdinal == 24) {
            ...
            while (i9 < list.size()) {
                zzapVarZzb4 = zzgVar.zzb((zzap) list.get(i9));
        ...
        if (iOrdinal == 18) {
            ...
            while (i9 < list.size() - 1) {
                zzap zzapVarZzb10 = zzgVar.zzb((zzap) list.get(i9));
                zzap zzapVarZzb11 = zzgVar.zzb((zzap) list.get(i9 + 1));
        ...
        if (iOrdinal == 35 || iOrdinal == 36) {
            ...
            if (zzapVarZzb12 instanceof zzat) {
                if (Name.LENGTH.equals(zzapVarZzb13.zzi())) {
