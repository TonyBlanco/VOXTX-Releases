...
public final class Tasks {
    ...
    public static <TResult> TResult await(Task<TResult> task, long j9, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        r.k();
        r.i();
        r.n(task, "Task must not be null");
    ...
    public static <T> Task<T> withTimeout(Task<T> task, long j9, TimeUnit timeUnit) {
        r.n(task, "Task must not be null");
        r.b(j9 > 0, "Timeout must be positive");
        r.n(timeUnit, "TimeUnit must not be null");
