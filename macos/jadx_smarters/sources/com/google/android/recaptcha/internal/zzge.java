...
final class zzge {
    ...
    */
    ...
    private final void zzm(Map.Entry entry) {
        ...
        zzgdVar.zzg();
        if (zzgdVar.zze() != zzjw.MESSAGE || (objZze = zze(zzgdVar)) == null) {
            zziyVar = this.zza;
            objZzl = zzl(value);
        } else {
            if (objZze instanceof zzid) {
                objZzl = zzgdVar.zzc((zzid) objZze, (zzid) value);
            } else {
                zzhx zzhxVarZzW = ((zzhy) objZze).zzW();
                zzgdVar.zzb(zzhxVarZzW, (zzhy) value);
                objZzl = zzhxVarZzW.zzj();
            }
            zziyVar = this.zza;
        }
        zziyVar.put(zzgdVar, objZzl);
    }
    ...
    private static final int zzo(Map.Entry entry) {
        ...
        zzgdVar.zzg();
        zzgdVar.zzf();
        boolean z9 = value instanceof zzhd;
        int iZza = ((zzgd) entry.getKey()).zza();
        if (!z9) {
            int iZzy = zzfk.zzy(iZza);
            int iZzy2 = zzfk.zzy(24) + zzfk.zzv((zzhy) value);
            int iZzy3 = zzfk.zzy(16);
            int iZzy4 = zzfk.zzy(8);
            return iZzy4 + iZzy4 + iZzy3 + iZzy + iZzy2;
        }
        int iZzy5 = zzfk.zzy(iZza);
        int iZza2 = ((zzhd) value).zza();
        int iZzy6 = zzfk.zzy(iZza2) + iZza2;
    ...
    public final void zzh(zzge zzgeVar) {
        for (int i9 = 0; i9 < zzgeVar.zza.zzb(); i9++) {
            zzm(zzgeVar.zza.zzg(i9));
        }
    ...
    */
    public final void zzi(com.google.android.recaptcha.internal.zzgd r6, java.lang.Object r7) {
        /*
            ...
            com.google.android.recaptcha.internal.zzjw r2 = com.google.android.recaptcha.internal.zzjw.INT
