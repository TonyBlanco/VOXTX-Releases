...
final class zzfl implements zzjx {
    ...
    public final void zzC(int i9, List list, boolean z9) throws IOException {
        ...
        if (!z9) {
            while (i10 < list.size()) {
                ...
                zzfkVar.zzp(i9, (iIntValue >> 31) ^ (iIntValue + iIntValue));
                i10++;
            }
            return;
        }
    ...
    public final void zzE(int i9, List list, boolean z9) throws IOException {
        ...
        if (!z9) {
            while (i10 < list.size()) {
                ...
                zzfkVar.zzr(i9, (jLongValue >> 63) ^ (jLongValue + jLongValue));
                i10++;
            }
            return;
        }
    ...
    public final void zzJ(int i9, List list, boolean z9) throws IOException {
        ...
        int iZzy = 0;
        for (int i11 = 0; i11 < list.size(); i11++) {
            iZzy += zzfk.zzy(((Integer) list.get(i11)).intValue());
        }
        this.zza.zzq(iZzy);
        while (i10 < list.size()) {
    ...
    public final void zzL(int i9, List list, boolean z9) throws IOException {
        ...
        int iZzz = 0;
        for (int i11 = 0; i11 < list.size(); i11++) {
            iZzz += zzfk.zzz(((Long) list.get(i11)).longValue());
        }
        this.zza.zzq(iZzz);
        while (i10 < list.size()) {
    ...
    @Override // com.google.android.recaptcha.internal.zzjx
    public final void zzd(int i9, zzez zzezVar) throws IOException {
        this.zza.zze(i9, zzezVar);
    }

    @Override // com.google.android.recaptcha.internal.zzjx
    public final void zze(int i9, List list) throws IOException {
        for (int i10 = 0; i10 < list.size(); i10++) {
            this.zza.zze(i9, (zzez) list.get(i10));
        }
    }
    ...
    public final void zzj(int i9, List list, boolean z9) throws IOException {
        ...
        int iZzu = 0;
        for (int i11 = 0; i11 < list.size(); i11++) {
            iZzu += zzfk.zzu(((Integer) list.get(i11)).intValue());
        }
        this.zza.zzq(iZzu);
        while (i10 < list.size()) {
    ...
    @Override // com.google.android.recaptcha.internal.zzjx
    public final void zzq(int i9, Object obj, zzil zzilVar) throws IOException {
        zzfk zzfkVar = this.zza;
        zzfkVar.zzo(i9, 3);
    ...
    @Override // com.google.android.recaptcha.internal.zzjx
    public final void zzv(int i9, Object obj, zzil zzilVar) throws IOException {
