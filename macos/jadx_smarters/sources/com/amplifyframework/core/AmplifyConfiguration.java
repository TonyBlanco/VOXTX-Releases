...
public final class AmplifyConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder devMenuEnabled(boolean z9) {
            this.devMenuEnabled = z9;
            return this;
        }
    }
    ...
    private AmplifyConfiguration(Map<String, CategoryConfiguration> map, Map<UserAgent.Platform, String> map2, boolean z9) {
    ...
    public AmplifyConfiguration(Map<String, CategoryConfiguration> map, boolean z9) {
        this(map, new LinkedHashMap(), z9);
    }
    ...
    public static Builder builder(Context context) throws AmplifyException {
        ...
        } catch (Resources.ResourceLoadingException e9) {
            throw new AmplifyException("Failed to load the amplifyconfiguration configuration file.", e9, "Is there an Amplify configuration file present in your app project, under ./app/src/main/res/raw/amplifyconfiguration?");
        }
    }

    public static Builder builder(Context context, int i9) throws AmplifyException {
        Objects.requireNonNull(context);
        try {
            return builder(Resources.readJsonResourceFromId(context, i9));
        } catch (Resources.ResourceLoadingException e9) {
            throw new AmplifyException("Failed to read JSON from resource = " + i9, e9, "If you are attempting to load a custom configuration file, please ensure that it exists in your application project under app/src/main/res/raw/<YOUR_CUSTOM_CONFIG_FILE>.");
        }
    }
    ...
    private static Map<String, CategoryConfiguration> configsFromJson(JSONObject jSONObject) throws AmplifyException {
        List<CategoryConfiguration> listAsList = Arrays.asList(new AnalyticsCategoryConfiguration(), new ApiCategoryConfiguration(), new AuthCategoryConfiguration(), new DataStoreCategoryConfiguration(), new GeoCategoryConfiguration(), new HubCategoryConfiguration(), new LoggingCategoryConfiguration(), new PredictionsCategoryConfiguration(), new StorageCategoryConfiguration());
        ...
        try {
            ...
            throw new AmplifyException("Could not parse amplifyconfiguration.json ", e9, "Check any modifications made to the file.");
        }
    }
    ...
    public static AmplifyConfiguration fromConfigFile(Context context, int i9) throws AmplifyException {
        return builder(context, i9).build();
    }
