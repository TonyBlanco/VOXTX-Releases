...
public final class AuthCategory extends Category<AuthPlugin<?>> implements AuthCategoryBehavior {
    ...
    public void confirmResetPassword(String str, String str2, AuthConfirmResetPasswordOptions authConfirmResetPasswordOptions, Action action, Consumer<AuthException> consumer) {
        getSelectedPlugin().confirmResetPassword(str, str2, authConfirmResetPasswordOptions, action, consumer);
    }
    ...
    @Override // com.amplifyframework.auth.AuthCategoryBehavior
    public void resendSignUpCode(String str, AuthResendSignUpCodeOptions authResendSignUpCodeOptions, Consumer<AuthSignUpResult> consumer, Consumer<AuthException> consumer2) {
    ...
    @Override // com.amplifyframework.auth.AuthCategoryBehavior
    public void signOut(AuthSignOutOptions authSignOutOptions, Action action, Consumer<AuthException> consumer) {
