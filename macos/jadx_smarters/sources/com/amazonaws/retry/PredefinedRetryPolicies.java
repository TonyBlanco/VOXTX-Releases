...
public class PredefinedRetryPolicies {
    ...
    public static final class SDKDefaultBackoffStrategy implements RetryPolicy.BackoffStrategy {
        ...
        private SDKDefaultBackoffStrategy(int i9, int i10) {
        ...
        public final long delayBeforeNextRetry(AmazonWebServiceRequest amazonWebServiceRequest, AmazonClientException amazonClientException, int i9) {
            if (i9 <= 0) {
                return 0L;
            }
            return this.random.nextInt(Math.min(this.maxDelayMs, (1 << i9) * this.baseDelayMs));
        }
    }
    ...
    public static RetryPolicy getDefaultRetryPolicyWithCustomMaxRetries(int i9) {
        return new RetryPolicy(DEFAULT_RETRY_CONDITION, DEFAULT_BACKOFF_STRATEGY, i9, false);
    }
    ...
    public static RetryPolicy getDynamoDBDefaultRetryPolicyWithCustomMaxRetries(int i9) {
        return new RetryPolicy(DEFAULT_RETRY_CONDITION, DEFAULT_BACKOFF_STRATEGY, i9, false);
    }
}
