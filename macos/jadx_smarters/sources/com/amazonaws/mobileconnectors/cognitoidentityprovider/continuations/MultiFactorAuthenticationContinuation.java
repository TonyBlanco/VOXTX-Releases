...
public class MultiFactorAuthenticationContinuation implements CognitoIdentityProviderContinuation<CognitoUserCodeDeliveryDetails> {
    ...
    public MultiFactorAuthenticationContinuation(CognitoUser cognitoUser, Context context, RespondToAuthChallengeResult respondToAuthChallengeResult, boolean z9, AuthenticationHandler authenticationHandler) {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        runnableRespondToMfaChallenge2 = new Runnable() { // from class: com.amazonaws.mobileconnectors.cognitoidentityprovider.continuations.MultiFactorAuthenticationContinuation.1.1
                            @Override // java.lang.Runnable
                            public void run() {
                                MultiFactorAuthenticationContinuation.this.callback.onFailure(e9);
                            }
                        };
                    }
    ...
    public CognitoUserCodeDeliveryDetails getParameters() {
        return CognitoServiceConstants.CHLG_TYPE_SOFTWARE_TOKEN_MFA.equals(this.challenge.getChallengeName()) ? new CognitoUserCodeDeliveryDetails("Time-based One-time Password", this.challenge.getChallengeParameters().get("FRIENDLY_DEVICE_NAME"), null) : "SMS_MFA".equals(this.challenge.getChallengeName()) ? new CognitoUserCodeDeliveryDetails(this.challenge.getChallengeParameters().get(CognitoServiceConstants.CHLG_PARAM_CODE_DEL_DESTINATION), this.challenge.getChallengeParameters().get(CognitoServiceConstants.CHLG_PARAM_CODE_DEL_MEDIUM), null) : new CognitoUserCodeDeliveryDetails("", "", "");
    }
