...
public abstract class TransferNetworkConnectionType {
    ...
    static {
        int i9 = 0;
        TransferNetworkConnectionType transferNetworkConnectionType = new TransferNetworkConnectionType("ANY", i9) { // from class: com.amazonaws.mobileconnectors.s3.transferutility.TransferNetworkConnectionType.1
        ...
        while (i9 < length) {
            TransferNetworkConnectionType transferNetworkConnectionType4 = transferNetworkConnectionTypeArrValues[i9];
    ...
    private TransferNetworkConnectionType(String str, int i9) {
    }
