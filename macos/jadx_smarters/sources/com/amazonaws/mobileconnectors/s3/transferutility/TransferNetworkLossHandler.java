        ...
        synchronized (this) {
            ...
            try {
                ...
                while (cursorQueryTransfersWithTypeAndStates.moveToNext()) {
                    int i10 = cursorQueryTransfersWithTypeAndStates.getInt(cursorQueryTransfersWithTypeAndStates.getColumnIndexOrThrow("_id"));
                    if (this.updater.getTransfer(i10) == null) {
                ...
                try {
                    ...
                    LOGGER.error("Error in resuming the transfers." + e9.getMessage());
                }
                LOGGER.debug(i9 + " transfers are loaded from database.");
            } catch (Throwable th) {
