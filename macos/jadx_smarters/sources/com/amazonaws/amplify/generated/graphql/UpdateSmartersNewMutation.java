...
public final class UpdateSmartersNewMutation implements InterfaceC2867e {
    ...
    private static final InterfaceC2869g OPERATION_NAME = new InterfaceC2869g() { // from class: com.amazonaws.amplify.generated.graphql.UpdateSmartersNewMutation.1
    ...
    public static class Data implements InterfaceC2868f.a {
        static final k[] $responseFields = {k.f("updateSmartersNew", "updateSmartersNew", new f(2).b("input", new f(2).b("kind", "Variable").b("variableName", "input").a()).b("condition", new f(2).b("kind", "Variable").b("variableName", "condition").a()).a(), true, Collections.emptyList())};
        ...
        public static final class Mapper implements l {
            ...
            public Data map(n nVar) {
                return new Data((UpdateSmartersNew) nVar.b(Data.$responseFields[0], new n.c() { // from class: com.amazonaws.amplify.generated.graphql.UpdateSmartersNewMutation.Data.Mapper.1
                    @Override // v1.n.c
                    public UpdateSmartersNew read(n nVar2) {
                        return Mapper.this.updateSmartersNewFieldMapper.map(nVar2);
                    }
                }));
            }
        }
        ...
        public m marshaller() {
            return new m() { // from class: com.amazonaws.amplify.generated.graphql.UpdateSmartersNewMutation.Data.1
                @Override // v1.m
    ...
    public static class UpdateSmartersNew {
        ...
        public m marshaller() {
            return new m() { // from class: com.amazonaws.amplify.generated.graphql.UpdateSmartersNewMutation.UpdateSmartersNew.1
                @Override // v1.m
                public void marshal(o oVar) {
                    k[] kVarArr = UpdateSmartersNew.$responseFields;
    ...
    public static final class Variables extends InterfaceC2868f.b {
        ...
        public Variables(g gVar, d dVar) {
        ...
        public static /* synthetic */ g access$000(Variables variables) {
            variables.getClass();
            return null;
        }
        ...
        public InterfaceC2865c marshaller() {
            return new InterfaceC2865c() { // from class: com.amazonaws.amplify.generated.graphql.UpdateSmartersNewMutation.Variables.1
    ...
    public UpdateSmartersNewMutation(g gVar, d dVar) {
