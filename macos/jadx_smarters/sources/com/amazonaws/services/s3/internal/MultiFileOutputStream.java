...
public class MultiFileOutputStream extends OutputStream implements OnFileDelete {
    ...
    public void cleanup() {
        for (int i9 = 0; i9 < getNumFilesWritten(); i9++) {
            File file = getFile(i9);
    ...
    public File getFile(int i9) {
        return new File(this.root, this.namePrefix + InstructionFileId.DOT + i9);
    }
    ...
    public MultiFileOutputStream init(UploadObjectObserver uploadObjectObserver, long j9, long j10) {
        ...
        if (j10 >= (j9 << 1)) {
            ...
            this.diskLimit = j10;
            int i9 = (int) (j10 / j9);
            this.diskPermits = i9 < 0 ? null : new Semaphore(i9);
            return this;
        }
    ...
    public void write(byte[] bArr, int i9, int i10) throws IOException {
        ...
        fos().write(bArr, i9, i10);
        this.currFileBytesWritten += i10;
        this.totalBytesWritten += (long) i10;
    }
}
