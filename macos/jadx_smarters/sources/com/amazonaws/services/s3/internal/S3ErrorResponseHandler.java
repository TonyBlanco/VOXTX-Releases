...
public class S3ErrorResponseHandler implements HttpResponseHandler<AmazonServiceException> {
    ...
    private AmazonServiceException.ErrorType errorTypeOf(int i9) {
        return i9 >= 500 ? AmazonServiceException.ErrorType.Service : AmazonServiceException.ErrorType.Client;
    }
            ...
            try {
                ...
                try {
                    ...
                    if (log2.isDebugEnabled()) {
                        log2.debug("Failed in parsing the response as XML: " + string, e9);
                    }
