...
public class AmazonS3EncryptionClient extends AmazonS3Client implements AmazonS3Encryption {
    ...
    public AmazonS3EncryptionClient(AWSKMSClient aWSKMSClient, AWSCredentialsProvider aWSCredentialsProvider, EncryptionMaterialsProvider encryptionMaterialsProvider, ClientConfiguration clientConfiguration, CryptoConfiguration cryptoConfiguration, RequestMetricCollector requestMetricCollector) {
        ...
        boolean z9 = aWSKMSClient == null;
        this.isKMSClientInternal = z9;
        AWSKMSClient aWSKMSClientNewAWSKMSClient = z9 ? newAWSKMSClient(aWSCredentialsProvider, clientConfiguration, cryptoConfiguration, requestMetricCollector) : aWSKMSClient;
    ...
    private <T extends Throwable> T onAbort(UploadObjectObserver uploadObjectObserver, T t9) {
    ...
    public void deleteObject(DeleteObjectRequest deleteObjectRequest) {
        ...
        DeleteObjectRequest deleteObjectRequest2 = (DeleteObjectRequest) deleteObjectRequest.mo5clone();
    ...
    @Override // com.amazonaws.services.s3.AmazonS3Client, com.amazonaws.services.s3.AmazonS3, com.amazonaws.services.s3.internal.S3DirectSpi
    public PutObjectResult putObject(PutObjectRequest putObjectRequest) {
        return this.crypto.putObjectSecurely(putObjectRequest.mo5clone());
    }
            ...
            try {
                try {
                    try {
                        ...
                        throw ((ExecutionException) onAbort(uploadObjectObserver, e9));
                    }
                } catch (IOException e10) {
                    throw ((IOException) onAbort(uploadObjectObserver, e10));
                } catch (InterruptedException e11) {
                    throw ((InterruptedException) onAbort(uploadObjectObserver, e11));
                }
            } catch (Error e12) {
                throw ((Error) onAbort(uploadObjectObserver, e12));
            } catch (RuntimeException e13) {
                throw ((RuntimeException) onAbort(uploadObjectObserver, e13));
            }
        } catch (Throwable th) {
            if (z9) {
                executorService.shutdownNow();
