...
public class CopyPartRequest extends AmazonWebServiceRequest implements Serializable, S3AccelerateUnsupported {
    ...
    public void setFirstByte(Long l9) {
        this.firstByte = l9;
    }

    public void setLastByte(Long l9) {
        this.lastByte = l9;
    }
    ...
    public CopyPartRequest withFirstByte(Long l9) {
        this.firstByte = l9;
        return this;
    }

    public CopyPartRequest withLastByte(Long l9) {
        this.lastByte = l9;
        return this;
    }
    ...
    public CopyPartRequest withPartNumber(int i9) {
        this.partNumber = i9;
        return this;
    }
