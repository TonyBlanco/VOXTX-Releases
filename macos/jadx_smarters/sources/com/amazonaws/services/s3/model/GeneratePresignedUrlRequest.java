...
public class GeneratePresignedUrlRequest extends AmazonWebServiceRequest implements SSECustomerKeyProvider, Serializable {
    ...
    public void setSSECustomerKeyAlgorithm(SSEAlgorithm sSEAlgorithm) {
        SSECustomerKey sSECustomerKeyGenerateSSECustomerKeyForPresignUrl;
        if (sSEAlgorithm == null) {
            sSECustomerKeyGenerateSSECustomerKeyForPresignUrl = null;
        } else {
            ...
            sSECustomerKeyGenerateSSECustomerKeyForPresignUrl = SSECustomerKey.generateSSECustomerKeyForPresignUrl(sSEAlgorithm.getAlgorithm());
        }
        this.sseCustomerKey = sSECustomerKeyGenerateSSECustomerKeyForPresignUrl;
    }
    ...
    public void setZeroByteContent(boolean z9) {
        this.zeroByteContent = z9;
    }
    ...
    public GeneratePresignedUrlRequest withZeroByteContent(boolean z9) {
        setZeroByteContent(z9);
        return this;
    }
}
