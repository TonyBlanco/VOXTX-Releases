...
abstract class DelegatingHttpsURLConnection extends HttpsURLConnection {
    ...
    public String getHeaderField(int i9) {
        return this.delegate.getHeaderField(i9);
    }
    ...
    public long getHeaderFieldDate(String str, long j9) {
        return this.delegate.getHeaderFieldDate(str, j9);
    }

    @Override // java.net.URLConnection
    public int getHeaderFieldInt(String str, int i9) {
        return this.delegate.getHeaderFieldInt(str, i9);
    }

    @Override // java.net.HttpURLConnection, java.net.URLConnection
    public String getHeaderFieldKey(int i9) {
        return this.delegate.getHeaderFieldKey(i9);
    }
    ...
    public void setAllowUserInteraction(boolean z9) {
        this.delegate.setAllowUserInteraction(z9);
    }

    @Override // java.net.HttpURLConnection
    public void setChunkedStreamingMode(int i9) {
        this.delegate.setChunkedStreamingMode(i9);
    }

    @Override // java.net.URLConnection
    public void setConnectTimeout(int i9) {
        this.delegate.setConnectTimeout(i9);
    }

    @Override // java.net.URLConnection
    public void setDefaultUseCaches(boolean z9) {
        this.delegate.setDefaultUseCaches(z9);
    }

    @Override // java.net.URLConnection
    public void setDoInput(boolean z9) {
        this.delegate.setDoInput(z9);
    }

    @Override // java.net.URLConnection
    public void setDoOutput(boolean z9) {
        this.delegate.setDoOutput(z9);
    }

    @Override // java.net.HttpURLConnection
    public void setFixedLengthStreamingMode(int i9) {
        this.delegate.setFixedLengthStreamingMode(i9);
    }
    ...
    public void setIfModifiedSince(long j9) {
        this.delegate.setIfModifiedSince(j9);
    }

    @Override // java.net.HttpURLConnection
    public void setInstanceFollowRedirects(boolean z9) {
        this.delegate.setInstanceFollowRedirects(z9);
    }

    @Override // java.net.URLConnection
    public void setReadTimeout(int i9) {
        this.delegate.setReadTimeout(i9);
    }
