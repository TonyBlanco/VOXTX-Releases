...
class Huffman {
    ...
    private void addCode(int i9, int i10, byte b9) {
        Node node = new Node(i9, b9);
        ...
        while (b9 > 8) {
            ...
            if (node2.children[i11] == null) {
                node2.children[i11] = new Node();
            }
    ...
    public void encode(byte[] bArr, OutputStream outputStream) throws IOException {
        ...
        for (byte b9 : bArr) {
            int i10 = b9 & 255;
            int i11 = CODES[i10];
            byte b10 = CODE_LENGTHS[i10];
            j9 = (j9 << b10) | ((long) i11);
            i9 += b10;
            while (i9 >= 8) {
                i9 -= 8;
                outputStream.write((int) (j9 >> i9));
            }
        }
        if (i9 > 0) {
            outputStream.write((int) ((j9 << (8 - i9)) | ((long) (255 >>> i9))));
        }
    }
