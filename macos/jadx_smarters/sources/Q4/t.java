...
public final class t extends MediaSessionCompat.Callback {
    ...
    public final /* synthetic */ w f46883a;
    ...
    public final void a(long j9) {
        C2434i c2434i = this.f46883a.f46899n;
        if (c2434i == null) {
            return;
        }
        b(Math.min(c2434i.p(), Math.max(0L, c2434i.g() + j9)));
    }
    ...
    */
    ...
    public final boolean onMediaButtonEvent(Intent intent) {
        w.f46885w.a("onMediaButtonEvent", new Object[0]);
    ...
    public final void onPause() {
        w.f46885w.a("onPause", new Object[0]);
        w wVar = this.f46883a;
        if (wVar.f46899n != null) {
            wVar.f46899n.W();
        }
    ...
    public final void onPlay() {
        w.f46885w.a("onPlay", new Object[0]);
        w wVar = this.f46883a;
        if (wVar.f46899n != null) {
            wVar.f46899n.W();
        }
    ...
    public final void onSeekTo(long j9) {
        w.f46885w.a("onSeekTo %d", Long.valueOf(j9));
        b(j9);
    }

    @Override // android.support.v4.media.session.MediaSessionCompat.Callback
    public final void onSkipToNext() {
        w.f46885w.a("onSkipToNext", new Object[0]);
        w wVar = this.f46883a;
        if (wVar.f46899n != null) {
            wVar.f46899n.J(null);
        }
    ...
    public final void onSkipToPrevious() {
        w.f46885w.a("onSkipToPrevious", new Object[0]);
        w wVar = this.f46883a;
        if (wVar.f46899n != null) {
            wVar.f46899n.K(null);
        }
