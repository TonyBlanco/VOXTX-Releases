...
public interface Stream<T> extends InterfaceC1970h {
    ...
    public final /* synthetic */ class Wrapper implements java.util.stream.Stream {
        ...
        public static /* synthetic */ java.util.stream.Stream convert(Stream stream) {
            ...
            return stream instanceof C1944b3 ? ((C1944b3) stream).f42597a : new Wrapper();
        }
        ...
        public final /* synthetic */ Object collect(Collector collector) {
            return Stream.this.h(C1980j.a(collector));
        }
        ...
        public final /* synthetic */ java.util.stream.Stream flatMap(Function function) {
            return convert(Stream.this.e(AbstractC2055y0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ DoubleStream flatMapToDouble(Function function) {
            return E.k(Stream.this.z(AbstractC2055y0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.IntStream flatMapToInt(Function function) {
            return IntStream.Wrapper.convert(Stream.this.t(AbstractC2055y0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ LongStream flatMapToLong(Function function) {
            return C1996m0.k(Stream.this.o(AbstractC2055y0.R(function)));
        }
        ...
        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.Stream limit(long j9) {
            return convert(Stream.this.limit(j9));
        }
        ...
        public final /* synthetic */ LongStream mapToLong(ToLongFunction toLongFunction) {
            return C1996m0.k(Stream.this.mapToLong(toLongFunction));
        }
        ...
        public final /* synthetic */ BaseStream onClose(Runnable runnable) {
            return C1965g.k(Stream.this.onClose(runnable));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream parallel() {
            return C1965g.k(Stream.this.parallel());
        }
        ...
        public final /* synthetic */ BaseStream sequential() {
            return C1965g.k(Stream.this.sequential());
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.Stream skip(long j9) {
            return convert(Stream.this.skip(j9));
        }
        ...
        public final /* synthetic */ BaseStream unordered() {
            return C1965g.k(Stream.this.unordered());
        }
    }
    ...
    InterfaceC2001n0 mapToLong(ToLongFunction toLongFunction);
    ...
    InterfaceC2001n0 o(C1935a c1935a);
