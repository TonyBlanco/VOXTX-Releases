...
final class W3 extends AbstractC1981j0 {
    ...
    final Spliterator P(AbstractC1940b abstractC1940b, Spliterator spliterator) {
        return EnumC1959e3.ORDERED.q(abstractC1940b.K()) ? O(abstractC1940b, spliterator, new C1948c2(8)).spliterator() : new j4((j$.util.K) abstractC1940b.X(spliterator), 1);
    }

    @Override // j$.util.stream.AbstractC1940b
    final InterfaceC2018q2 R(int i9, InterfaceC2018q2 interfaceC2018q2) {
        return new V3(this, interfaceC2018q2);
    }
}
