...
final class Y3 extends AbstractC1981j0 implements d4 {
    ...
    final Spliterator P(AbstractC1940b abstractC1940b, Spliterator spliterator) {
        return EnumC1959e3.ORDERED.q(abstractC1940b.K()) ? O(abstractC1940b, spliterator, new C1948c2(9)).spliterator() : new j4((j$.util.K) abstractC1940b.X(spliterator), 0);
    }

    @Override // j$.util.stream.AbstractC1940b
    final InterfaceC2018q2 R(int i9, InterfaceC2018q2 interfaceC2018q2) {
        return new X3(this, interfaceC2018q2, false);
    }

    @Override // j$.util.stream.d4
    public final e4 k(C0 c02, boolean z9) {
        return new X3(this, c02, z9);
    }
}
