...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z9) throws RemoteException {
                Callback callback = this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(11, Boolean.valueOf(z9), null);
                }
            }
            ...
            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onShuffleModeChangedRemoved(boolean z9) throws RemoteException {
            }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i9, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(AbstractC0524g.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(M0.a.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
        ...
        public Bundle getSessionInfo() {
            ...
            if (this.mSessionToken.getExtraBinder() != null) {
                try {
                    ...
                    Log.e(MediaControllerCompat.TAG, "Dead object in getSessionInfo.", e9);
        ...
        public TransportControls getTransportControls() {
            ...
            return i9 >= 29 ? new TransportControlsApi29(transportControls) : i9 >= 24 ? new TransportControlsApi24(transportControls) : i9 >= 23 ? new TransportControlsApi23(transportControls) : new TransportControlsApi21(transportControls);
        }
    ...
    public static class MediaControllerImplBase implements MediaControllerImpl {
        ...
        public Bundle getSessionInfo() {
            try {
                ...
                Log.d(MediaControllerCompat.TAG, "Dead object in getSessionInfo.", e9);
            }
            Bundle bundleUnparcelWithClassLoader = MediaSessionCompat.unparcelWithClassLoader(this.mSessionInfo);
            this.mSessionInfo = bundleUnparcelWithClassLoader;
            return bundleUnparcelWithClassLoader == null ? Bundle.EMPTY : new Bundle(this.mSessionInfo);
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(int i9, int i10, int i11, int i12, int i13) {
            this(i9, new AudioAttributesCompat.a().b(i10).a(), i11, i12, i13);
        }

        public PlaybackInfo(int i9, AudioAttributesCompat audioAttributesCompat, int i10, int i11, int i12) {
    ...
    public static class TransportControlsApi21 extends TransportControls {
        ...
        public void skipToQueueItem(long j9) {
            this.mControlsFwk.skipToQueueItem(j9);
        }
    ...
    public static class TransportControlsApi29 extends TransportControlsApi24 {
        ...
        public void setPlaybackSpeed(float f9) {
            ...
            this.mControlsFwk.setPlaybackSpeed(f9);
        }
    }
    ...
    public static class TransportControlsBase extends TransportControls {
        ...
        public void setCaptioningEnabled(boolean z9) {
            try {
                this.mBinder.setCaptioningEnabled(z9);
            } catch (RemoteException e9) {
        ...
        public void setPlaybackSpeed(float f9) {
            ...
            try {
                this.mBinder.setPlaybackSpeed(f9);
            } catch (RemoteException e9) {
                Log.e(MediaControllerCompat.TAG, "Dead object in setPlaybackSpeed.", e9);
            }
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        Object tag = activity.getWindow().getDecorView().getTag(AbstractC2526j.f46764a);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        activity.getWindow().getDecorView().setTag(AbstractC2526j.f46764a, mediaControllerCompat);
