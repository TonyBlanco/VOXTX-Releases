...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((C2518b) message.obj);
        ...
        public class MediaSessionCallbackApi21 extends MediaSession.Callback {
            ...
            private void setCurrentControllerInfo(MediaSessionImpl mediaSessionImpl) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(new C2518b(callingPackage, -1, -1));
            }
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        AbstractC0524g.b(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, iBinderAsBinder);
                        M0.a.c(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
                        ...
                        if (str.equals(MediaControllerCompat.COMMAND_REMOVE_QUEUE_ITEM)) {
                            ...
                            if (i9 >= 0 && i9 < sessionImplIfCallbackIsSet.mQueue.size()) {
                                queueItem = sessionImplIfCallbackIsSet.mQueue.get(i9);
                            }
                            if (queueItem != null) {
                                callback = Callback.this;
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            C2518b currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        C2518b getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(C2518b c2518b);
        ...
        void setPlaybackToRemote(AbstractC2527k abstractC2527k);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j9) {
            ...
            return (j9 & 256) != 0 ? rccTransportControlFlagsFromActions | JceEncryptionConstants.SYMMETRIC_KEY_LENGTH : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public int getRccTransportControlFlagsFromActions(long j9) {
            int rccTransportControlFlagsFromActions = super.getRccTransportControlFlagsFromActions(j9);
            return (j9 & 128) != 0 ? rccTransportControlFlagsFromActions | IjkMediaMeta.FF_PROFILE_H264_CONSTRAINED : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new C2518b("android.media.session.MediaController", callingPid, callingUid));
        ...
        public String getCallingPackage() {
            ...
            try {
                ...
                Log.e(MediaSessionCompat.TAG, "Cannot execute MediaSession.getCallingPackage()", e9);
                return null;
            }
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public C2518b getCurrentControllerInfo() {
            C2518b c2518b;
            synchronized (this.mLock) {
                c2518b = this.mRemoteUserInfo;
            }
            return c2518b;
        }
        ...
        public void release() {
            ...
            if (Build.VERSION.SDK_INT == 27) {
                try {
                    ...
                    Log.w(MediaSessionCompat.TAG, "Exception happened while accessing MediaSession.mCallback.", e9);
                }
            }
        ...
        public void setCaptioningEnabled(boolean z9) {
            if (this.mCaptioningEnabled != z9) {
                this.mCaptioningEnabled = z9;
                synchronized (this.mLock) {
                    for (int iBeginBroadcast = this.mExtraControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                        try {
                            ((IMediaControllerCallback) this.mExtraControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z9);
                        } catch (RemoteException unused) {
                        }
                    }
                    this.mExtraControllerCallbacks.finishBroadcast();
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(C2518b c2518b) {
            synchronized (this.mLock) {
                this.mRemoteUserInfo = c2518b;
            }
        }
        ...
        public void setFlags(int i9) {
            this.mSessionFwk.setFlags(i9 | 3);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(AbstractC2527k abstractC2527k) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) abstractC2527k.d());
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        ...
        public void setRatingType(int i9) {
            this.mSessionFwk.setRatingType(i9);
        }
    }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public final C2518b getCurrentControllerInfo() {
            return new C2518b(this.mSessionFwk.getCurrentControllerInfo());
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        RegistrationCallbackHandler mRegistrationCallbackHandler;
        private C2518b mRemoteUserInfo;
        int mRepeatMode;
        ...
        AbstractC2527k mVolumeProvider;
        int mVolumeType;
        final Object mLock = new Object();
        ...
        int mFlags = 3;
        private AbstractC2527k.d mVolumeCallback = new AbstractC2527k.d() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // q0.AbstractC2527k.d
            public void onVolumeChanged(AbstractC2527k abstractC2527k) {
                if (MediaSessionImplBase.this.mVolumeProvider != abstractC2527k) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, abstractC2527k.c(), abstractC2527k.b(), abstractC2527k.a()));
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    try {
                        ...
                        AbstractC2527k abstractC2527k = mediaSessionImplBase.mVolumeProvider;
                        i11 = 2;
                        if (i9 == 2) {
                            int iC = abstractC2527k.c();
                            int iB = abstractC2527k.b();
                            streamVolume = abstractC2527k.a();
                            streamMaxVolume = iB;
                            i11 = iC;
                        } else {
            ...
            public void postToHandler(int i9, int i10, int i11) {
                MediaSessionImplBase.this.postToHandler(i9, i10, i11, null, null);
            }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                int callingPid = Binder.getCallingPid();
                int callingUid = Binder.getCallingUid();
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new C2518b(MediaSessionImplBase.this.getPackageNameForUid(callingUid), callingPid, callingUid));
                synchronized (MediaSessionImplBase.this.mLock) {
                    try {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setCaptioningEnabled(boolean z9) throws RemoteException {
                postToHandler(29, Boolean.valueOf(z9));
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void setPlaybackSpeed(float f9) throws RemoteException {
                postToHandler(32, Float.valueOf(f9));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new C2518b(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        private void sendCaptioningEnabled(boolean z9) {
            synchronized (this.mLock) {
                for (int iBeginBroadcast = this.mControllerCallbacks.beginBroadcast() - 1; iBeginBroadcast >= 0; iBeginBroadcast--) {
                    try {
                        ((IMediaControllerCallback) this.mControllerCallbacks.getBroadcastItem(iBeginBroadcast)).onCaptioningEnabledChanged(z9);
                    } catch (RemoteException unused) {
                    }
                }
        ...
        public void adjustVolume(int i9, int i10) {
            ...
            AbstractC2527k abstractC2527k = this.mVolumeProvider;
            if (abstractC2527k != null) {
                abstractC2527k.e(i9);
            }
        }
        ...
        */
        ...
        public String getPackageNameForUid(int i9) {
            String nameForUid = this.mContext.getPackageManager().getNameForUid(i9);
        ...
        public void setPlaybackToRemote(AbstractC2527k abstractC2527k) {
            ...
            AbstractC2527k abstractC2527k2 = this.mVolumeProvider;
            if (abstractC2527k2 != null) {
                abstractC2527k2.g(null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = abstractC2527k;
            ...
            abstractC2527k.g(this.mVolumeCallback);
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public static class Api21Impl {
            ...
            public static MediaSession.QueueItem createQueueItem(MediaDescription mediaDescription, long j9) {
    ...
    public interface RegistrationCallback {
        void onCallbackRegistered(int i9, int i10);

        void onCallbackUnregistered(int i9, int i10);
    }
    ...
    public static final class RegistrationCallbackHandler extends Handler {
        ...
        public void postCallbackRegistered(int i9, int i10) {
            obtainMessage(1001, i9, i10).sendToTarget();
        }

        public void postCallbackUnregistered(int i9, int i10) {
            obtainMessage(1002, i9, i10).sendToTarget();
        }
    }
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession iMediaSessionAsInterface = IMediaSession.Stub.asInterface(AbstractC0524g.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            M0.d dVarB = M0.a.b(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, iMediaSessionAsInterface, dVarB);
        }
            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (iMediaSession != null) {
                        AbstractC0524g.b(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                    }
                    M0.d dVar = this.mSession2Token;
                    if (dVar != null) {
                        M0.a.c(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, dVar);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    public MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, M0.d dVar) {
        ...
        if (componentName == null && (componentName = AbstractC2702a.a(context)) == null) {
        ...
        this.mImpl = i9 >= 29 ? new MediaSessionImplApi29(context, str, dVar, bundle) : i9 >= 28 ? new MediaSessionImplApi28(context, str, dVar, bundle) : i9 >= 22 ? new MediaSessionImplApi22(context, str, dVar, bundle) : new MediaSessionImplApi21(context, str, dVar, bundle);
    ...
    public static MediaSessionCompat fromMediaSession(Context context, Object obj) {
        ...
        return new MediaSessionCompat(context, i9 >= 29 ? new MediaSessionImplApi29(obj) : i9 >= 28 ? new MediaSessionImplApi28(obj) : new MediaSessionImplApi21(obj));
    }
    ...
    public void setCaptioningEnabled(boolean z9) {
        this.mImpl.setCaptioningEnabled(z9);
    }
    ...
    public void setPlaybackToRemote(AbstractC2527k abstractC2527k) {
        ...
        this.mImpl.setPlaybackToRemote(abstractC2527k);
    }
