...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static class Api21Impl {
        ...
        public static PlaybackState.CustomAction.Builder createCustomActionBuilder(String str, CharSequence charSequence, int i9) {
        ...
        public static void setActions(PlaybackState.Builder builder, long j9) {
            builder.setActions(j9);
        }

        public static void setActiveQueueItemId(PlaybackState.Builder builder, long j9) {
            builder.setActiveQueueItemId(j9);
        }

        public static void setBufferedPosition(PlaybackState.Builder builder, long j9) {
        ...
        public static void setState(PlaybackState.Builder builder, int i9, long j9, float f9, long j10) {
