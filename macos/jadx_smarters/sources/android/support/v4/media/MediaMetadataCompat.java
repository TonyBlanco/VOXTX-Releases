...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final C2695a METADATA_KEYS_TYPE;
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            C2695a c2695a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c2695a.containsKey(str) || ((Integer) c2695a.get(str)).intValue() == 2) {
        ...
        public Builder putLong(String str, long j9) {
            C2695a c2695a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c2695a.containsKey(str) || ((Integer) c2695a.get(str)).intValue() == 0) {
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            C2695a c2695a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c2695a.containsKey(str) || ((Integer) c2695a.get(str)).intValue() == 3) {
        ...
        public Builder putString(String str, String str2) {
            C2695a c2695a = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if (!c2695a.containsKey(str) || ((Integer) c2695a.get(str)).intValue() == 1) {
    ...
    static {
        ...
        METADATA_KEYS_TYPE = c2695a;
        c2695a.put(METADATA_KEY_TITLE, 1);
        c2695a.put(METADATA_KEY_ARTIST, 1);
        c2695a.put(METADATA_KEY_DURATION, 0);
        c2695a.put(METADATA_KEY_ALBUM, 1);
        c2695a.put(METADATA_KEY_AUTHOR, 1);
        c2695a.put(METADATA_KEY_WRITER, 1);
        c2695a.put(METADATA_KEY_COMPOSER, 1);
        c2695a.put(METADATA_KEY_COMPILATION, 1);
        c2695a.put(METADATA_KEY_DATE, 1);
        c2695a.put(METADATA_KEY_YEAR, 0);
        c2695a.put(METADATA_KEY_GENRE, 1);
        c2695a.put(METADATA_KEY_TRACK_NUMBER, 0);
        c2695a.put(METADATA_KEY_NUM_TRACKS, 0);
        c2695a.put(METADATA_KEY_DISC_NUMBER, 0);
        c2695a.put(METADATA_KEY_ALBUM_ARTIST, 1);
        c2695a.put(METADATA_KEY_ART, 2);
        c2695a.put(METADATA_KEY_ART_URI, 1);
        c2695a.put(METADATA_KEY_ALBUM_ART, 2);
        c2695a.put(METADATA_KEY_ALBUM_ART_URI, 1);
        c2695a.put(METADATA_KEY_USER_RATING, 3);
        c2695a.put(METADATA_KEY_RATING, 3);
        c2695a.put(METADATA_KEY_DISPLAY_TITLE, 1);
        c2695a.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        c2695a.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        c2695a.put(METADATA_KEY_DISPLAY_ICON, 2);
        c2695a.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        c2695a.put(METADATA_KEY_MEDIA_ID, 1);
        c2695a.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        c2695a.put(METADATA_KEY_MEDIA_URI, 1);
        c2695a.put(METADATA_KEY_ADVERTISEMENT, 0);
        c2695a.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
