...
public interface ICustomTabsCallback extends IInterface {
    ...
    public static class Default implements ICustomTabsCallback {
        ...
        @Override // android.support.customtabs.ICustomTabsCallback
        public void onNavigationEvent(int i9, Bundle bundle) throws RemoteException {
        }
            ...
            public void onNavigationEvent(int i9, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(2, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onNavigationEvent(i9, bundle);
                        parcelObtain2.recycle();
                        parcelObtain.recycle();
                    }
                } catch (Throwable th) {
            ...
            public void onRelationshipValidationResult(int i9, Uri uri, boolean z9, Bundle bundle) throws RemoteException {
                ...
                try {
                    ...
                    if (this.mRemote.transact(6, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        ...
                        Stub.getDefaultImpl().onRelationshipValidationResult(i9, uri, z9, bundle);
                        parcelObtain2.recycle();
                        parcelObtain.recycle();
                    }
                } catch (Throwable th) {
    ...
    void onNavigationEvent(int i9, Bundle bundle) throws RemoteException;

    void onPostMessage(String str, Bundle bundle) throws RemoteException;

    void onRelationshipValidationResult(int i9, Uri uri, boolean z9, Bundle bundle) throws RemoteException;
}
