...
public abstract class c {
    ...
    */
    ...
    public static void f(Camera.Parameters parameters, int i9, int i10) {
        int[] next;
        String str;
    ...
    public static void g(Camera.Parameters parameters, i.a aVar, boolean z9) {
        ...
        String strB = (z9 || aVar == i.a.AUTO) ? b("focus mode", supportedFocusModes, "auto") : aVar == i.a.CONTINUOUS ? b("focus mode", supportedFocusModes, "continuous-picture", "continuous-video", "auto") : aVar == i.a.INFINITY ? b("focus mode", supportedFocusModes, "infinity") : aVar == i.a.MACRO ? b("focus mode", supportedFocusModes, "macro") : null;
        if (!z9 && strB == null) {
        ...
        if (strB != null) {
            ...
            Log.i("CameraConfiguration", "Focus mode already set to " + strB);
        }
    }
    ...
    public static void k(Camera.Parameters parameters, boolean z9) {
        ...
        String strB = z9 ? b("flash mode", supportedFlashModes, "torch", "on") : b("flash mode", supportedFlashModes, "off");
        if (strB != null) {
            if (strB.equals(parameters.getFlashMode())) {
                Log.i("CameraConfiguration", "Flash mode already set to " + strB);
                return;
            }
            Log.i("CameraConfiguration", "Setting flash mode to " + strB);
