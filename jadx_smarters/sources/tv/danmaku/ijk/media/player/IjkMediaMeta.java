...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public IjkStreamMeta(int i9) {
            this.mIndex = i9;
        }

        public String getBitrateInline() {
            long j9 = this.mBitrate;
        ...
        public String getChannelLayoutInline() {
            long j9 = this.mChannelLayout;
            return j9 <= 0 ? "N/A" : j9 == 4 ? "mono" : j9 == 3 ? "stereo" : String.format(Locale.US, "%x", Long.valueOf(j9));
        }
        ...
        public String getFpsInline() {
            ...
            return (i10 <= 0 || (i9 = this.mFpsDen) <= 0) ? "N/A" : String.valueOf(i10 / i9);
        }
        ...
        public String getResolutionInline() {
            int i9 = this.mWidth;
            return (i9 <= 0 || this.mHeight <= 0) ? "N/A" : (this.mSarNum <= 0 || this.mSarDen <= 0) ? String.format(Locale.US, "%d x %d", Integer.valueOf(i9), Integer.valueOf(this.mHeight)) : String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i9), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        int i9 = -1;
        int i10 = ijkMediaMeta.getInt("video", -1);
        int i11 = ijkMediaMeta.getInt("audio", -1);
        ...
        for (Bundle bundle2 : parcelableArrayList) {
            i9++;
            if (bundle2 != null) {
                IjkStreamMeta ijkStreamMeta = new IjkStreamMeta(i9);
    ...
    public String getDurationInline() {
        long j9 = (this.mDurationUS + 5000) / 1000000;
        long j10 = j9 / 60;
        return String.format(Locale.US, "%02d:%02d:%02d", Long.valueOf(j10 / 60), Long.valueOf(j10 % 60), Long.valueOf(j9 % 60));
    }
