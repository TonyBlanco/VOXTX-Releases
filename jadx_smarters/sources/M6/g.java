...
public final class g {
    ...
    public final List f5187a = new ArrayList();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final List f5188b = new ArrayList();

    public final void a(int[] iArr, String str) {
        this.f5187a.add(iArr);
        this.f5188b.add(str);
    }
    ...
    public String c(String str) {
        ...
        int i9;
        b();
        int i10 = Integer.parseInt(str.substring(0, 3));
        int size = this.f5187a.size();
        for (int i11 = 0; i11 < size && i10 >= (i9 = (iArr = (int[]) this.f5187a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i9 = iArr[1];
            }
            if (i10 <= i9) {
                return (String) this.f5188b.get(i11);
            }
        }
        return null;
    }
