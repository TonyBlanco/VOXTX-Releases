...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    private static boolean matchIdentity(String str, String str2, boolean z9) {
        boolean zEndsWith;
        if (str == null) {
            return false;
        }
        ...
        if (strArrSplit.length < 3 || !strArrSplit[0].endsWith("*") || (z9 && !validCountryWildcard(strArrSplit))) {
        ...
        if (zEndsWith) {
            return !z9 || countDots(lowerCase) == countDots(lowerCase2);
        }
        return false;
    }
    ...
    public final void verify(String str, String[] strArr, String[] strArr2, boolean z9) throws SSLException {
        ...
        if (listAsList != null) {
            for (String strNormaliseAddress2 : listAsList) {
                ...
                if (matchIdentity(strNormaliseAddress, strNormaliseAddress2, z9)) {
                    return;
                }
            }
        ...
        if (matchIdentity(strNormaliseAddress, InetAddressUtils.isIPv6Address(str2) ? DefaultHostnameVerifier.normaliseAddress(str2) : str2, z9)) {
            return;
        }
