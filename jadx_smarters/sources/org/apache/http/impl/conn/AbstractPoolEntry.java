...
public abstract class AbstractPoolEntry {
    ...
    public void open(HttpRoute httpRoute, HttpContext httpContext, HttpParams httpParams) throws IOException {
        ...
        boolean zIsSecure = this.connection.isSecure();
        if (proxyHost == null) {
            routeTracker.connectTarget(zIsSecure);
        } else {
            routeTracker.connectProxy(proxyHost, zIsSecure);
        }
    }
    ...
    public void tunnelProxy(HttpHost httpHost, boolean z9, HttpParams httpParams) throws IOException {
        ...
        Asserts.notNull(this.tracker, "Route tracker");
        Asserts.check(this.tracker.isConnected(), "Connection not open");
        this.connection.update(null, httpHost, z9, httpParams);
        this.tracker.tunnelProxy(httpHost, z9);
    }
    ...
    public void tunnelTarget(boolean z9, HttpParams httpParams) throws IOException {
        ...
        this.connection.update(null, this.tracker.getTargetHost(), z9, httpParams);
        this.tracker.tunnelTarget(z9);
    }
}
