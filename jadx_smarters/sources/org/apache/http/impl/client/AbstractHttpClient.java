...
public abstract class AbstractHttpClient extends CloseableHttpClient {
        ...
        try {
            if (this.protocolProcessor == null) {
                ...
                for (int i9 = 0; i9 < requestInterceptorCount; i9++) {
                    httpRequestInterceptorArr[i9] = httpProcessor.getRequestInterceptor(i9);
                }
                ...
                for (int i10 = 0; i10 < responseInterceptorCount; i10++) {
                    httpResponseInterceptorArr[i10] = httpProcessor.getResponseInterceptor(i10);
                }
    ...
    public synchronized void addRequestInterceptor(HttpRequestInterceptor httpRequestInterceptor, int i9) {
        getHttpProcessor().addInterceptor(httpRequestInterceptor, i9);
        this.protocolProcessor = null;
    }
    ...
    public synchronized void addResponseInterceptor(HttpResponseInterceptor httpResponseInterceptor, int i9) {
        getHttpProcessor().addInterceptor(httpResponseInterceptor, i9);
        this.protocolProcessor = null;
    }
    ...
    public final CloseableHttpResponse doExecute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException {
    ...
    public synchronized HttpRequestInterceptor getRequestInterceptor(int i9) {
        return getHttpProcessor().getRequestInterceptor(i9);
    }
    ...
    public synchronized HttpResponseInterceptor getResponseInterceptor(int i9) {
        return getHttpProcessor().getResponseInterceptor(i9);
    }
