...
public class ServerBootstrap {
    ...
    public HttpServer create() {
        ...
        ?? r72 = uriHttpRequestHandlerMapper;
        ...
        HttpService httpService = new HttpService(httpProcessor, connectionReuseStrategy2, httpResponseFactory, (HttpRequestHandlerMapper) r72, this.expectationVerifier);
        ...
        return new HttpServer(i10, inetAddress, socketConfig, serverSocketFactory2, httpService, httpConnectionFactory, this.sslSetupHandler, exceptionLogger2);
    }
