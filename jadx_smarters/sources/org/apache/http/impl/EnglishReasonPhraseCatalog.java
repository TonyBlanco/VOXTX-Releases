...
public class EnglishReasonPhraseCatalog implements ReasonPhraseCatalog {
    ...
    private static void setReason(int i9, String str) {
        int i10 = i9 / 100;
        REASON_PHRASES[i10][i9 - (i10 * 100)] = str;
    }

    @Override // org.apache.http.ReasonPhraseCatalog
    public String getReason(int i9, Locale locale) {
        Args.check(i9 >= 100 && i9 < 600, "Unknown category for status code " + i9);
        int i10 = i9 / 100;
        int i11 = i9 - (i10 * 100);
        String[] strArr = REASON_PHRASES[i10];
