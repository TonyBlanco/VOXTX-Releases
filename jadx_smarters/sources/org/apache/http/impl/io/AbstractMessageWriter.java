...
public abstract class AbstractMessageWriter<T extends HttpMessage> implements HttpMessageWriter<T> {
    ...
    public void write(T t9) throws HttpException, IOException {
        Args.notNull(t9, "HTTP message");
        writeHeadLine(t9);
        HeaderIterator headerIterator = t9.headerIterator();
    ...
    public abstract void writeHeadLine(T t9) throws IOException;
}
