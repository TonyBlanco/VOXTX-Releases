...
public abstract class AbstractSessionOutputBuffer implements SessionOutputBuffer, BufferInfo {
    ...
    public AbstractSessionOutputBuffer(OutputStream outputStream, int i9, Charset charset, int i10, CodingErrorAction codingErrorAction, CodingErrorAction codingErrorAction2) {
    ...
    public void init(OutputStream outputStream, int i9, HttpParams httpParams) {
        Args.notNull(outputStream, "Input stream");
        Args.notNegative(i9, "Buffer size");
    ...
    public void write(byte[] bArr, int i9, int i10) throws IOException {
        ...
        if (i10 > this.minChunkLimit || i10 > this.buffer.capacity()) {
            flushBuffer();
