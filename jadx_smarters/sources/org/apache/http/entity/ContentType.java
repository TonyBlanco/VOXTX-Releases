...
public final class ContentType implements Serializable {
    ...
    static {
        ...
        ContentType contentTypeCreate6 = create(Mimetypes.MIMETYPE_XML, charset);
        ...
        ContentType contentTypeCreate15 = create(Mimetypes.MIMETYPE_HTML, charset);
    ...
    private static ContentType create(String str, NameValuePair[] nameValuePairArr, boolean z9) {
        ...
        while (true) {
            ...
            NameValuePair nameValuePair = nameValuePairArr[i9];
    ...
    private static ContentType create(HeaderElement headerElement, boolean z9) {
        return create(headerElement.getName(), headerElement.getParameters(), z9);
    }
