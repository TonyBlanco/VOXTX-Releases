...
public class TextNode extends Node {
    ...
    */
    ...
    public TextNode splitText(int i9) {
        Validate.isTrue(i9 >= 0, "Split offset must be not be negative");
        Validate.isTrue(i9 < this.text.length(), "Split offset must not be greater than current text length");
        String strSubstring = getWholeText().substring(0, i9);
        String strSubstring2 = getWholeText().substring(i9);
        text(strSubstring);
