...
class GJLocaleSymbols {
    ...
    private static void addNumerals(TreeMap<String, Integer> treeMap, int i9, int i10, Integer[] numArr) {
        while (i9 <= i10) {
            treeMap.put(String.valueOf(i9).intern(), numArr[i9]);
            i9++;
        }
    }
    ...
    private static int maxLength(String[] strArr) {
        ...
        while (true) {
            ...
            if (str != null && (length = str.length()) > i9) {
                i9 = length;
            }
        }
    }
    ...
    public String dayOfWeekValueToShortText(int i9) {
        return this.iShortDaysOfWeek[i9];
    }

    public String dayOfWeekValueToText(int i9) {
        return this.iDaysOfWeek[i9];
    }
    ...
    public String eraValueToText(int i9) {
        return this.iEras[i9];
    }
    ...
    public String halfdayValueToText(int i9) {
        return this.iHalfday[i9];
    }
    ...
    public String monthOfYearValueToShortText(int i9) {
        return this.iShortMonths[i9];
    }

    public String monthOfYearValueToText(int i9) {
        return this.iMonths[i9];
    }
}
