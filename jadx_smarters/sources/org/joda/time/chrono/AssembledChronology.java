...
public abstract class AssembledChronology extends BaseChronology {
    ...
    private void setFields() {
        ...
        int i9 = 0;
        if (chronology2 != null) {
            int i10 = ((this.iHourOfDay == chronology2.hourOfDay() && this.iMinuteOfHour == this.iBase.minuteOfHour() && this.iSecondOfMinute == this.iBase.secondOfMinute() && this.iMillisOfSecond == this.iBase.millisOfSecond()) ? 1 : 0) | (this.iMillisOfDay == this.iBase.millisOfDay() ? 2 : 0);
    ...
    public long getDateTimeMillis(int i9, int i10, int i11, int i12) throws IllegalArgumentException {
        Chronology chronology = this.iBase;
        return (chronology == null || (this.iBaseFlags & 6) != 6) ? super.getDateTimeMillis(i9, i10, i11, i12) : chronology.getDateTimeMillis(i9, i10, i11, i12);
    }

    @Override // org.joda.time.chrono.BaseChronology, org.joda.time.Chronology
    public long getDateTimeMillis(int i9, int i10, int i11, int i12, int i13, int i14, int i15) throws IllegalArgumentException {
        Chronology chronology = this.iBase;
        return (chronology == null || (this.iBaseFlags & 5) != 5) ? super.getDateTimeMillis(i9, i10, i11, i12, i13, i14, i15) : chronology.getDateTimeMillis(i9, i10, i11, i12, i13, i14, i15);
    }

    @Override // org.joda.time.chrono.BaseChronology, org.joda.time.Chronology
    public long getDateTimeMillis(long j9, int i9, int i10, int i11, int i12) throws IllegalArgumentException {
        Chronology chronology = this.iBase;
        return (chronology == null || (this.iBaseFlags & 1) != 1) ? super.getDateTimeMillis(j9, i9, i10, i11, i12) : chronology.getDateTimeMillis(j9, i9, i10, i11, i12);
    }
