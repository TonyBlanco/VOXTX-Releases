...
public abstract class BaseDurationField extends DurationField implements Serializable {
    ...
    public long getMillis(int i9) {
        return ((long) i9) * getUnitMillis();
    }

    @Override // org.joda.time.DurationField
    public long getMillis(long j9) {
        return FieldUtils.safeMultiply(j9, getUnitMillis());
    }
    ...
    public int getValue(long j9) {
        return FieldUtils.safeToInt(getValueAsLong(j9));
    }

    @Override // org.joda.time.DurationField
    public int getValue(long j9, long j10) {
        return FieldUtils.safeToInt(getValueAsLong(j9, j10));
    }

    @Override // org.joda.time.DurationField
    public long getValueAsLong(long j9) {
        return j9 / getUnitMillis();
    }
