...
public class DateTimeUtils {
    ...
    public static class FixedMillisProvider implements MillisProvider {
        ...
        public FixedMillisProvider(long j9) {
            this.iMillis = j9;
        }
    ...
    public static class OffsetMillisProvider implements MillisProvider {
        ...
        public OffsetMillisProvider(long j9) {
            this.iMillis = j9;
        }
    ...
    public static final long fromJulianDay(double d9) {
        return (long) ((d9 - 2440587.5d) * 8.64E7d);
    }
    ...
    public static final Map<String, DateTimeZone> getDefaultTimeZoneNames() {
        ...
        return !z1.a(atomicReference, null, mapBuildDefaultTimeZoneNames) ? atomicReference.get() : mapBuildDefaultTimeZoneNames;
    }
    ...
    public static final boolean isContiguous(ReadablePartial readablePartial) {
        ...
        for (int i9 = 0; i9 < readablePartial.size(); i9++) {
            ...
            if (i9 > 0 && (field.getRangeDurationField() == null || field.getRangeDurationField().getType() != type)) {
                return false;
            }
    ...
    public static final void setCurrentMillisFixed(long j9) throws SecurityException {
        checkPermission();
        cMillisProvider = new FixedMillisProvider(j9);
    }

    public static final void setCurrentMillisOffset(long j9) throws SecurityException {
        checkPermission();
        if (j9 == 0) {
            cMillisProvider = SYSTEM_MILLIS_PROVIDER;
        } else {
            cMillisProvider = new OffsetMillisProvider(j9);
        }
    }
    ...
    public static final double toJulianDay(long j9) {
        return (j9 / 8.64E7d) + 2440587.5d;
    }

    public static final long toJulianDayNumber(long j9) {
        return (long) Math.floor(toJulianDay(j9) + 0.5d);
    }
}
