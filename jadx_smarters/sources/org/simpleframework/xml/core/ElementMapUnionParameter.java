...
class ElementMapUnionParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<ElementMap> {
        public Contact(ElementMap elementMap, Constructor constructor, int i9) {
            super(elementMap, constructor, i9);
        }
    ...
    public ElementMapUnionParameter(Constructor constructor, ElementMapUnion elementMapUnion, ElementMap elementMap, Format format, int i9) throws Exception {
        Contact contact = new Contact(elementMap, constructor, i9);
