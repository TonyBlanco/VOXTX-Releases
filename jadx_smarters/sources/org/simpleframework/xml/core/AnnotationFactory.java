...
class AnnotationFactory {
    ...
    private Annotation getInstance(ClassLoader classLoader, Class cls, boolean z9) throws Exception {
        return (Annotation) Proxy.newProxyInstance(classLoader, new Class[]{cls}, new AnnotationHandler(cls, this.required, z9));
    }
