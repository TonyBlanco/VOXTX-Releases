...
class TextParameter extends TemplateParameter {
    ...
    public static class Contact extends ParameterContact<Text> {
        public Contact(Text text, Constructor constructor, int i9) {
            super(text, constructor, i9);
        }
    ...
    public TextParameter(Constructor constructor, Text text, Format format, int i9) throws Exception {
        Contact contact = new Contact(text, constructor, i9);
