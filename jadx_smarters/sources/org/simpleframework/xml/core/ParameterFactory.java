...
class ParameterFactory {
    ...
    public Parameter getInstance(Constructor constructor, Annotation annotation, int i9) throws Exception {
        return getInstance(constructor, annotation, null, i9);
    }

    public Parameter getInstance(Constructor constructor, Annotation annotation, Annotation annotation2, int i9) throws Exception {
        Constructor constructor2 = getConstructor(annotation);
        return (Parameter) (annotation2 != null ? constructor2.newInstance(constructor, annotation, annotation2, this.format, Integer.valueOf(i9)) : constructor2.newInstance(constructor, annotation, this.format, Integer.valueOf(i9)));
    }
}
