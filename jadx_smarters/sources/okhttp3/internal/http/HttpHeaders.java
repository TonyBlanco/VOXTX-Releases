...
public final class HttpHeaders {
    ...
    public static final List<Challenge> parseChallenges(@NotNull Headers parseChallenges, @NotNull String headerName) {
        ...
        for (int i9 = 0; i9 < size; i9++) {
            if (n.o(headerName, parseChallenges.name(i9), true)) {
                try {
                    readChallengeHeader(new Buffer().writeUtf8(parseChallenges.value(i9)), arrayList);
    ...
    public static final boolean promisesBody(@NotNull Response promisesBody) {
        ...
        if (l.a(promisesBody.request().method(), HttpHead.METHOD_NAME)) {
            return false;
        }
        int iCode = promisesBody.code();
        return (((iCode >= 100 && iCode < 200) || iCode == 204 || iCode == 304) && Util.headersContentLength(promisesBody) == -1 && !n.o(HTTP.CHUNK_CODING, Response.header$default(promisesBody, "Transfer-Encoding", null, 2, null), true)) ? false : true;
    }
    ...
    */
    private static final void readChallengeHeader(okio.Buffer r7, java.util.List<okhttp3.Challenge> r8) throws java.io.EOFException {
        ...
        L1f:
            ...
            java.util.Map r0 = l8.AbstractC2205B.d()
            r7.<init>(r1, r0)
            r8.add(r7)
            return
        L2c:
    ...
    private static final String readQuotedString(Buffer buffer) throws EOFException {
        ...
        while (true) {
            ...
            if (buffer.getByte(jIndexOfElement) == b9) {
    ...
    private static final boolean startsWith(Buffer buffer, byte b9) {
        return !buffer.exhausted() && buffer.getByte(0L) == b9;
    }
}
