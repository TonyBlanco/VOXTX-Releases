...
public final class RealConnection implements Connection {
    ...
    private void connectSocket(int i9, int i10, int i11, ConnectionSpecSelector connectionSpecSelector) throws Throwable {
        this.rawSocket.setSoTimeout(i10);
        try {
            Platform.get().connectSocket(this.rawSocket, this.route.getSocketAddress(), i9);
    ...
    private void connectTls(int i9, int i10, ConnectionSpecSelector connectionSpecSelector) throws Throwable {
        SSLSocket sSLSocket;
    ...
    private void createTunnel(int i9, int i10) throws IOException {
        ...
        do {
            ...
            Util.skipAll(sourceNewFixedLengthSource, a.e.API_PRIORITY_OTHER, timeUnit);
    ...
    public void connect(int i9, int i10, int i11, List<ConnectionSpec> list, boolean z9) throws RouteException {
        ...
        while (this.protocol == null) {
            try {
                ...
                connectSocket(i9, i10, i11, connectionSpecSelector);
