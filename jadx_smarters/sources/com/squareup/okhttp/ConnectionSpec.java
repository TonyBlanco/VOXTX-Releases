...
public final class ConnectionSpec {
    ...
    private ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z9) {
    ...
    public void apply(SSLSocket sSLSocket, boolean z9) {
    ...
    public boolean equals(Object obj) {
        ...
        boolean z9 = this.tls;
        if (z9 != connectionSpec.tls) {
            return false;
        }
        return !z9 || (Arrays.equals(this.cipherSuites, connectionSpec.cipherSuites) && Arrays.equals(this.tlsVersions, connectionSpec.tlsVersions) && this.supportsTlsExtensions == connectionSpec.supportsTlsExtensions);
    }
