...
public class ClientConfiguration {
    ...
    public void setCurlLogging(boolean z9) {
        this.curlLogging = z9;
    }

    public void setEnableGzip(boolean z9) {
        this.enableGzip = z9;
    }
    ...
    public void setMaxErrorRetry(int i9) {
        if (i9 < 0) {
            throw new IllegalArgumentException("maxErrorRetry shoud be non-negative");
        }
        this.maxErrorRetry = i9;
    }
    ...
    public void setSocketBufferSizeHints(int i9, int i10) {
        this.socketSendBufferSizeHint = i9;
        this.socketReceiveBufferSizeHint = i10;
    }
    ...
    public ClientConfiguration withConnectionTimeout(int i9) {
        setConnectionTimeout(i9);
        return this;
    }

    public ClientConfiguration withCurlLogging(boolean z9) {
        this.curlLogging = z9;
        return this;
    }

    public ClientConfiguration withEnableGzip(boolean z9) {
        setEnableGzip(z9);
        return this;
    }
    ...
    public ClientConfiguration withMaxConnections(int i9) {
        setMaxConnections(i9);
        return this;
    }

    public ClientConfiguration withMaxErrorRetry(int i9) {
        setMaxErrorRetry(i9);
        return this;
    }

    public ClientConfiguration withPreemptiveBasicProxyAuth(boolean z9) {
        setPreemptiveBasicProxyAuth(Boolean.valueOf(z9));
        return this;
    }
    ...
    public ClientConfiguration withProxyPort(int i9) {
        setProxyPort(i9);
        return this;
    }
    ...
    public ClientConfiguration withSocketBufferSizeHints(int i9, int i10) {
        setSocketBufferSizeHints(i9, i10);
        return this;
    }

    public ClientConfiguration withSocketTimeout(int i9) {
        setSocketTimeout(i9);
        return this;
    }
