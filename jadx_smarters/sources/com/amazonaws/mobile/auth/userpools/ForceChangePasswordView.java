...
public class ForceChangePasswordView extends LinearLayout {
    ...
    public ForceChangePasswordView(Context context, AttributeSet attributeSet, int i9) {
        ...
        setOrientation(1);
        if (!isInEditMode()) {
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ForgotPasswordView);
            typedArrayObtainStyledAttributes.getInt(R.styleable.ForgotPasswordView_forgotPasswordViewBackgroundColor, -12303292);
    ...
    public void onFinishInflate() {
        ...
        this.forceChangePassForm = formView;
        this.passwordEditText = formView.addFormField(getContext(), 129, getContext().getString(R.string.sign_in_password));
