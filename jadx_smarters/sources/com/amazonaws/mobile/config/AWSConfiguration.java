...
public class AWSConfiguration {
    ...
    public AWSConfiguration(Context context, int i9) {
        this(context, i9, DEFAULT);
    }

    public AWSConfiguration(Context context, int i9, String str) {
        this.configName = str;
        readInputJson(context, i9);
    }
    ...
    private void readInputJson(Context context, int i9) {
        try {
