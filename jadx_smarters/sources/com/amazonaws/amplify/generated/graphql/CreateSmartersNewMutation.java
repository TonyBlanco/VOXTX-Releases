...
public final class CreateSmartersNewMutation implements InterfaceC2867e {
    ...
    private static final InterfaceC2869g OPERATION_NAME = new InterfaceC2869g() { // from class: com.amazonaws.amplify.generated.graphql.CreateSmartersNewMutation.1
    ...
    public static class CreateSmartersNew {
        ...
        public m marshaller() {
            return new m() { // from class: com.amazonaws.amplify.generated.graphql.CreateSmartersNewMutation.CreateSmartersNew.1
                @Override // v1.m
    ...
    public static class Data implements InterfaceC2868f.a {
        static final k[] $responseFields = {k.f("createSmartersNew", "createSmartersNew", new f(2).b("input", new f(2).b("kind", "Variable").b("variableName", "input").a()).b("condition", new f(2).b("kind", "Variable").b("variableName", "condition").a()).a(), true, Collections.emptyList())};
        private volatile int $hashCode;
        private volatile boolean $hashCodeMemoized;
        private volatile String $toString;
        ...
        public static final class Mapper implements l {
            ...
            public Data map(n nVar) {
                return new Data((CreateSmartersNew) nVar.b(Data.$responseFields[0], new n.c() { // from class: com.amazonaws.amplify.generated.graphql.CreateSmartersNewMutation.Data.Mapper.1
                    @Override // v1.n.c
                    public CreateSmartersNew read(n nVar2) {
                        return Mapper.this.createSmartersNewFieldMapper.map(nVar2);
                    }
                }));
            }
        }
        ...
        public m marshaller() {
            return new m() { // from class: com.amazonaws.amplify.generated.graphql.CreateSmartersNewMutation.Data.1
                @Override // v1.m
                public void marshal(o oVar) {
    ...
    public static final class Variables extends InterfaceC2868f.b {
        ...
        public InterfaceC2865c marshaller() {
            return new InterfaceC2865c() { // from class: com.amazonaws.amplify.generated.graphql.CreateSmartersNewMutation.Variables.1
