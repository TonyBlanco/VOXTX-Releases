...
public class AssumeRoleWithSAMLResultStaxUnmarshaller implements Unmarshaller<AssumeRoleWithSAMLResult, StaxUnmarshallerContext> {
    ...
    public AssumeRoleWithSAMLResult unmarshall(StaxUnmarshallerContext staxUnmarshallerContext) throws Exception {
        ...
        while (true) {
            ...
            } else if (staxUnmarshallerContext.testExpression("Subject", i9)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("SubjectType", i9)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("Issuer", i9)) {
            ...
            } else if (staxUnmarshallerContext.testExpression("NameQualifier", i9)) {
