...
public final class S3Versions implements Iterable<S3VersionSummary> {
    ...
    public class VersionIterator implements Iterator<S3VersionSummary> {
        ...
        private void prepareCurrentListing() {
            VersionListing versionListingListNextBatchOfVersions;
            while (true) {
                ...
                if (this.currentListing == null) {
                    ...
                    versionListingListNextBatchOfVersions = S3Versions.this.getS3().listVersions(listVersionsRequest);
                } else {
                    versionListingListNextBatchOfVersions = S3Versions.this.getS3().listNextBatchOfVersions(this.currentListing);
                }
                this.currentListing = versionListingListNextBatchOfVersions;
    ...
    public S3Versions withBatchSize(int i9) {
