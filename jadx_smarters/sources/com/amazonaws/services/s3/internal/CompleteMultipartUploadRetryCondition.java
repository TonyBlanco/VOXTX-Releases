...
public class CompleteMultipartUploadRetryCondition implements RetryPolicy.RetryCondition {
    ...
    public CompleteMultipartUploadRetryCondition(int i9) {
        this.maxCompleteMultipartUploadRetries = i9;
    }
    ...
    public boolean shouldRetry(AmazonWebServiceRequest amazonWebServiceRequest, AmazonClientException amazonClientException, int i9) {
        return (amazonClientException instanceof AmazonS3Exception) && test((AmazonS3Exception) amazonClientException) && i9 < this.maxCompleteMultipartUploadRetries;
    }
