...
public class XmlResponsesSaxParser {
        ...
        public void doEndElement(String str, String str2, String str3) {
            ...
            if (in("AccessControlPolicy", "AccessControlList")) {
                ...
                if (!str2.equals("Permission")) {
                    ...
                    permission = Permission.parsePermission(getText());
                }
            }
        ...
        public void doStartElement(String str, String str2, String str3, Attributes attributes) {
            ...
            if (in("AccessControlPolicy")) {
                ...
                if ("AmazonCustomerByEmail".equals(strFindAttributeValue)) {
                    ...
                    if (!"CanonicalUser".equals(strFindAttributeValue)) {
        ...
        public void doEndElement(String str, String str2, String str3) {
            ...
            if (in("CORSConfiguration", "CORSRule")) {
                ...
                if (str2.equals("AllowedOrigin")) {
                    ...
                    objFromValue = CORSRule.AllowedMethods.fromValue(getText());
                    list.add(objFromValue);
    ...
    public static class CompleteMultipartUploadHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3VersionResult, S3RequesterChargedResult {
        ...
        public void setRequesterCharged(boolean z9) {
            CompleteMultipartUploadResult completeMultipartUploadResult = this.result;
            if (completeMultipartUploadResult != null) {
                completeMultipartUploadResult.setRequesterCharged(z9);
            }
        }
    ...
    public static class CopyObjectResultHandler extends AbstractSSEHandler implements ObjectExpirationResult, S3RequesterChargedResult, S3VersionResult {
        ...
        @Override // com.amazonaws.services.s3.internal.S3RequesterChargedResult
        public void setRequesterCharged(boolean z9) {
            this.result.setRequesterCharged(z9);
        }
    ...
    public static class ListBucketHandler extends AbstractHandler {
        ...
        public ListBucketHandler(boolean z9) {
            this.shouldSDKDecodeResponse = z9;
        }
    ...
    public static class ListObjectsV2Handler extends AbstractHandler {
        ...
        public ListObjectsV2Handler(boolean z9) {
            this.shouldSDKDecodeResponse = z9;
        }
    ...
    public static class ListVersionsHandler extends AbstractHandler {
        ...
        public ListVersionsHandler(boolean z9) {
            this.shouldSDKDecodeResponse = z9;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static String decodeIfSpecified(String str, boolean z9) {
        return z9 ? S3HttpUtils.urlDecode(str) : str;
    }
    ...
    public static int parseInt(String str) {
        try {
            ...
            log.error("Unable to parse integer value '" + str + "'", e9);
            return -1;
        }
    }
    ...
    public static long parseLong(String str) {
        try {
            ...
            log.error("Unable to parse long value '" + str + "'", e9);
            return -1L;
        }
    }
    ...
    public ListBucketHandler parseListBucketObjectsResponse(InputStream inputStream, boolean z9) throws IOException {
    ...
    public ListObjectsV2Handler parseListObjectsV2Response(InputStream inputStream, boolean z9) throws IOException {
        ListObjectsV2Handler listObjectsV2Handler = new ListObjectsV2Handler(z9);
    ...
    public ListVersionsHandler parseListVersionsResponse(InputStream inputStream, boolean z9) throws IOException {
        ListVersionsHandler listVersionsHandler = new ListVersionsHandler(z9);
        ...
        try {
            ...
            try {
                ...
                if (log.isErrorEnabled()) {
                    log.error("Unable to close response InputStream up after XML parse failure", e10);
                }
            }
    ...
    public InputStream sanitizeXmlDocument(DefaultHandler defaultHandler, InputStream inputStream) throws IOException {
        ...
        try {
            ...
            try {
                ...
                if (log.isErrorEnabled()) {
                    log.error("Unable to close response InputStream after failure sanitizing XML document", e10);
                }
            }
