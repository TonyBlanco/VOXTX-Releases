...
public class STSSessionCredentials implements AWSRefreshableSessionCredentials {
    ...
    public STSSessionCredentials(AWSCredentials aWSCredentials, int i9) {
        this.securityTokenService = new AWSSecurityTokenServiceClient(aWSCredentials);
        this.sessionDurationSeconds = i9;
    }
    ...
    public STSSessionCredentials(AWSSecurityTokenService aWSSecurityTokenService, int i9) {
