...
public class NewPasswordContinuation extends ChallengeContinuation {
    ...
    public NewPasswordContinuation(CognitoUser cognitoUser, Context context, String str, String str2, String str3, RespondToAuthChallengeResult respondToAuthChallengeResult, boolean z9, AuthenticationHandler authenticationHandler) {
        ...
        if (str != null) {
            try {
                ...
                for (int i9 = 0; i9 < jSONArray.length(); i9++) {
                    this.requiredAttributes.add(jSONArray.getString(i9).split("userAttributes.", 2)[1]);
                }
            } catch (Exception e9) {
