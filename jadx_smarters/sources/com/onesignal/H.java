...
public abstract class H {
    ...
    */
    ...
    public static JSONObject c(E e9, String str) {
        if (!e9.a(str)) {
            return null;
        }
        JSONObject jSONObject = new JSONObject();
        JSONObject jSONObjectE = e9.e(str);
    ...
    public static String f(JSONArray jSONArray) {
        ...
        for (int i9 = 0; i9 < jSONArray.length(); i9++) {
            try {
                str = str + ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR + jSONArray.getString(i9) + ModelIdentifier.Helper.PRIMARY_KEY_ENCAPSULATE_CHAR;
            } catch (JSONException unused) {
            }
        }
        return str + "]";
