...
public final class DataStoreCategory extends Category<DataStorePlugin<?>> implements DataStoreCategoryBehavior {
    ...
    @Override // com.amplifyframework.datastore.DataStoreCategoryBehavior
    public <T extends Model> void delete(T t9, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2) {
        getSelectedPlugin().delete(t9, consumer, consumer2);
    }

    @Override // com.amplifyframework.datastore.DataStoreCategoryBehavior
    public <T extends Model> void delete(T t9, QueryPredicate queryPredicate, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2) {
        getSelectedPlugin().delete(t9, queryPredicate, consumer, consumer2);
    }
    ...
    @Override // com.amplifyframework.datastore.DataStoreCategoryBehavior
    public <T extends Model> void save(T t9, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2) {
        getSelectedPlugin().save(t9, consumer, consumer2);
    }

    @Override // com.amplifyframework.datastore.DataStoreCategoryBehavior
    public <T extends Model> void save(T t9, QueryPredicate queryPredicate, Consumer<DataStoreItemChange<T>> consumer, Consumer<DataStoreException> consumer2) {
        getSelectedPlugin().save(t9, queryPredicate, consumer, consumer2);
    }
