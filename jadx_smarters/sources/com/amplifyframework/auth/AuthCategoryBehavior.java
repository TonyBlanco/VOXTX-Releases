...
public interface AuthCategoryBehavior {
    void confirmResetPassword(String str, String str2, AuthConfirmResetPasswordOptions authConfirmResetPasswordOptions, Action action, Consumer<AuthException> consumer);
    ...
    void resendSignUpCode(String str, AuthResendSignUpCodeOptions authResendSignUpCodeOptions, Consumer<AuthSignUpResult> consumer, Consumer<AuthException> consumer2);
