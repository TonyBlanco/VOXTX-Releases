...
public final class zzh {
    public static double zza(double d9) {
        if (Double.isNaN(d9)) {
            return 0.0d;
        }
        ...
        return ((double) (d9 > 0.0d ? 1 : -1)) * Math.floor(Math.abs(d9));
    }
    ...
    public static int zzb(double d9) {
        ...
        return (int) ((((double) (d9 > 0.0d ? 1 : -1)) * Math.floor(Math.abs(d9))) % 4.294967296E9d);
    }
    ...
    public static long zzd(double d9) {
        return ((long) zzb(d9)) & 4294967295L;
    }
    ...
    public static void zzh(String str, int i9, List list) {
        if (list.size() != i9) {
    ...
    public static void zzi(String str, int i9, List list) {
        if (list.size() < i9) {
    ...
    public static void zzj(String str, int i9, List list) {
        if (list.size() > i9) {
