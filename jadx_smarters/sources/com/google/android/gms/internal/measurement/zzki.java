...
public abstract class zzki extends zzjq {
    ...
    @Deprecated
    public static int zzt(int i9, zzmi zzmiVar, zzmt zzmtVar) {
    ...
    public static zzki zzz(byte[] bArr, int i9, int i10) {
    ...
    public abstract void zze(int i9, zzka zzkaVar) throws IOException;
