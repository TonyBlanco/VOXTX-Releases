...
public final class zzkt {
    ...
    static {
        ...
        zzkt[] zzktVarArrValues = values();
        zzZ = new zzkt[zzktVarArrValues.length];
        for (zzkt zzktVar52 : zzktVarArrValues) {
            zzZ[zzktVar52.zzac] = zzktVar52;
        }
    }

    private zzkt(String str, int i9, int i10, int i11, zzlm zzlmVar) {
        this.zzac = i10;
        this.zzab = zzlmVar;
        zzlm zzlmVar2 = zzlm.zza;
        int i12 = i11 - 1;
        this.zzad = (i12 == 1 || i12 == 3) ? zzlmVar.zza() : null;
        if (i11 == 1) {
            zzlmVar.ordinal();
        }
    }
