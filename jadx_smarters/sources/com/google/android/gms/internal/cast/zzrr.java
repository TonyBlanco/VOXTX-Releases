...
final class zzrr extends zzru {
    ...
    public zzrr(byte[] bArr, int i9, int i10) {
        super(null);
        if (bArr == null) {
    ...
    public final void zzb(byte b9) throws IOException {
        try {
            ...
            throw new zzrs(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), 1), e9);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i9, int i10) throws IOException {
        try {
            ...
            throw new zzrs(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zze), Integer.valueOf(this.zzd), Integer.valueOf(i10)), e9);
        }
    }
    ...
    @Override // com.google.android.gms.internal.cast.zzru
    public final void zze(int i9, zzrm zzrmVar) throws IOException {
        zzq((i9 << 3) | 2);
        zzq(zzrmVar.zzd());
        zzrmVar.zzh(this);
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            int i11 = i9 + iZzx2;
            this.zze = i11;
            int iZzb = zzvf.zzb(str, this.zzc, i11, this.zzd - i11);
            this.zze = i9;
            zzq((iZzb - i9) - iZzx2);
            this.zze = iZzb;
        } catch (zzve e9) {
    ...
    public final void zzs(long j9) throws IOException {
        if (zzru.zzd && this.zzd - this.zze >= 10) {
            while ((j9 & (-128)) != 0) {
                ...
                int i9 = this.zze;
                this.zze = i9 + 1;
                zzvb.zzn(bArr, i9, (byte) ((((int) j9) & 127) | 128));
                j9 >>>= 7;
            }
            byte[] bArr2 = this.zzc;
            int i10 = this.zze;
            this.zze = 1 + i10;
            zzvb.zzn(bArr2, i10, (byte) j9);
            return;
        }
        while ((j9 & (-128)) != 0) {
            try {
