...
public final class zzgs extends zzdb {
    ...
    public static class zza {
        ...
        public final zzgs zza() throws GeneralSecurityException {
            ...
            throw new GeneralSecurityException("Cannot use parsing strategy " + this.zzb.toString() + " when new keys are picked according to " + String.valueOf(this.zzc) + InstructionFileId.DOT);
        }
    }
