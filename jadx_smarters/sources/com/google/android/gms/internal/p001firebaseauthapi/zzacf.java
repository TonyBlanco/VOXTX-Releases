...
public final class zzacf {
    ...
    */
    public static A5.m zza(com.google.android.gms.common.api.Status r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzacf.zza(com.google.android.gms.common.api.Status):A5.m");
    }

    public static m zza(Status status, AbstractC0540g abstractC0540g, String str, String str2) {
        int I9 = status.I();
        if (I9 != 17012 && I9 != 17007 && I9 != 17025) {
            return zza(status);
        }
        return new r(zza(I9), zza(zzb(I9), status)).b(abstractC0540g).c(str).d(str2);
    }

    public static C0548o zza(FirebaseAuth firebaseAuth, zzyk zzykVar, AbstractC0553u abstractC0553u) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzykVar);
        Pair<String, String> pair = zza.get(17078);
        return new C0548o((String) pair.first, (String) pair.second, C0617h.I(zzykVar, firebaseAuth, abstractC0553u));
    }

    private static String zza(int i9) {
        Pair<String, String> pair = zza.get(i9);
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof C0545l) {
            return ((C0545l) exc).a().endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0545l) {
            return ((C0545l) exc).a().endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0545l) {
            return ((C0545l) exc).a().endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
}
