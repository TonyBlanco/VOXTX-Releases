...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public void write(JsonWriter jsonWriter, T t9) throws IOException {
            ...
            try {
                for (BoundField boundField : this.boundFields.values()) {
                    if (boundField.writeField(t9)) {
                        jsonWriter.name(boundField.name);
                        boundField.write(jsonWriter, t9);
                    }
                }
    ...
    public static abstract class BoundField {
        ...
        public BoundField(String str, boolean z9, boolean z10) {
            this.name = str;
            this.serialized = z9;
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z9, boolean z10) {
        ...
        return new BoundField(str, z9, z10) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
            ...
            public void write(JsonWriter jsonWriter, Object obj) throws IllegalAccessException, IOException {
                (z11 ? typeAdapter2 : new TypeAdapterRuntimeTypeWrapper(gson, typeAdapter2, typeToken.getType())).write(jsonWriter, field.get(obj));
            }
    ...
    public static boolean excludeField(Field field, boolean z9, Excluder excluder) {
        return (excluder.excludeClass(field.getType(), z9) || excluder.excludeField(field, z9)) ? false : true;
    }
    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls) {
        ...
        while (rawType != Object.class) {
            ...
            while (i9 < length) {
                ...
                boolean zExcludeField2 = excludeField(field, z9);
                if (zExcludeField || zExcludeField2) {
                    ...
                    while (i10 < size) {
                        ...
                        boolean z10 = i10 != 0 ? false : zExcludeField;
                        int i11 = i10;
                        BoundField boundField2 = boundField;
                        int i12 = size;
                        List<String> list = fieldNames;
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(typeResolve), z10, zExcludeField2)) : boundField2;
                        i10 = i11 + 1;
                        zExcludeField = z10;
                        fieldNames = list;
                        size = i12;
