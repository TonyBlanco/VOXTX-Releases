...
public class AdChoicesView extends RelativeLayout {
    ...
    @Deprecated
    public AdChoicesView(Context context, NativeAdBase nativeAdBase, boolean z9) {
        this((Context) Preconditions.checkNotNull(context, "Context can not be null."), nativeAdBase, z9, null);
    }

    @Deprecated
    public AdChoicesView(Context context, NativeAdBase nativeAdBase, boolean z9, NativeAdLayout nativeAdLayout) {
        super((Context) Preconditions.checkNotNull(context, "Context can not be null."));
        DynamicLoaderFactory.makeLoader(context).createAdChoicesViewApi(this, context, nativeAdBase);
    }
}
