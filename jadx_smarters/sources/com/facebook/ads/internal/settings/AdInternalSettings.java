...
public class AdInternalSettings {
    ...
    public static void setDebugBuild(boolean z9) {
        ...
        if (dynamicLoader != null && z9) {
            dynamicLoader.createAdSettingsApi().turnOnDebugger();
        }
        sSettingsBundle.putBoolean(BOOL_DEBUG_BUILD_KEY, z9);
    }
    ...
    public static void setTestMode(boolean z9) {
        sSettingsBundle.putBoolean(BOOL_EXPLICIT_TEST_MODE_KEY, z9);
    }
    ...
    public static void setVideoAutoplay(boolean z9) {
        sSettingsBundle.putBoolean(BOOL_VIDEO_AUTOPLAY_KEY, z9);
    }

    public static void setVideoAutoplayOnMobile(boolean z9) {
        sSettingsBundle.putBoolean(BOOL_AUTOPLAY_ON_MOBILE_KEY, z9);
    }

    public static void setVisibleAnimation(boolean z9) {
        sSettingsBundle.putBoolean(BOOL_VISIBLE_ANIMATION_KEY, z9);
    }
