...
public class j extends e {
    public j(i iVar, d dVar, long j9) {
        ...
        this.f7371b = iVar.k(byteBufferAllocate, 4 + j10);
        this.f7372c = iVar.k(byteBufferAllocate, 8 + j10);
        this.f7373d = iVar.k(byteBufferAllocate, j10 + 20);
    }
}
