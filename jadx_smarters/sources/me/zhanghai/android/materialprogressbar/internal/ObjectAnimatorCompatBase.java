...
class ObjectAnimatorCompatBase {
    ...
    private static void calculateXYValues(Path path, float[] fArr, float[] fArr2) {
        ...
        for (int i9 = 0; i9 < 201; i9++) {
            pathMeasure.getPosTan((i9 * length) / 200.0f, fArr3, null);
            fArr[i9] = fArr3[0];
            fArr2[i9] = fArr3[1];
        }
    }
    ...
    private static void calculateXYValues(Path path, int[] iArr, int[] iArr2) {
        ...
        for (int i9 = 0; i9 < 201; i9++) {
            pathMeasure.getPosTan((i9 * length) / 200.0f, fArr, null);
            iArr[i9] = Math.round(fArr[0]);
            iArr2[i9] = Math.round(fArr[1]);
        }
    }

    public static <T> ObjectAnimator ofArgb(T t9, Property<T, Integer> property, int... iArr) {
        ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(t9, property, iArr);
    ...
    public static <T> ObjectAnimator ofFloat(T t9, Property<T, Float> property, Property<T, Float> property2, Path path) {
        ...
        return ObjectAnimator.ofPropertyValuesHolder(t9, PropertyValuesHolder.ofFloat((Property<?, Float>) property, fArr), PropertyValuesHolder.ofFloat((Property<?, Float>) property2, fArr2));
    }
    ...
    public static <T> ObjectAnimator ofInt(T t9, Property<T, Integer> property, Property<T, Integer> property2, Path path) {
        ...
        return ObjectAnimator.ofPropertyValuesHolder(t9, PropertyValuesHolder.ofInt((Property<?, Integer>) property, iArr), PropertyValuesHolder.ofInt((Property<?, Integer>) property2, iArr2));
    }
